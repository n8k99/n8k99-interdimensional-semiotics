...
Values 79
2. Inner Duality and the History of Lingui.st.ics…. 81
...
vii
Chapter Page
4. TheDifference betweentheTwoClassesIllustrated
by Comparisons 87
5. TheTwoLinguisticsContrastedAccordingto Their
...
3. Linguistic Value from a Material Viewp . oi . nt …. HZ
...
I. The Two Perspectives of Diachronic Lingui.st.ics…. 212
...
4. Linguistic Type and Mind of the Socia.l G . ro . up .. 227
V. Language Families and Linguistic Types 228
Index 233

---

*[asset: TRANSLATOR'S INTRODUCTION, pending]*
---
...
itself;andphonation, i.e., theexecutionofsound-images, inno way
...
An argumentagainstseparatingphonationfromlanguagemight
...
of language itself. Dowe really have the right to pretend that lan-
gauge exists independently of phonetic changes? Yes, for they
affectonlythematerialsubstanceofwords. Iftheyattacklanguage
...
berofdisciplineswhich have noplace in linguisticsexcept through
their relation to language. —
Thestudyofspeechisthentwofold :itsbasicpart ^havingasits
object lan — gauge, which is purely social and independent — of the
individual isexclusivelypsychological ;itssecondarypart which
has asits object — t the individual side ofspeech, i.e. speaking, includ-
ing phonation is psychophysical.
Doubtlessthetwoobjectsare closelyconnected, eachdepending
...
first. Howwouldaspeakertakeituponhimselftoassociatean idea

---

:
LINGUISTICS OF LANGUAGE AND OF SPEAKING 19
with aword-imageifhehad notfirst come acrosstheassociationin
...
impressions gathered from listening to othersmodify our linguistic
habits. Languageandspeakingaretheninterdependent theformer
;
...
distinct things.
Languageexistsintheformof a sum of impressions deposited in
thebrain of each member of acommunity, almostlike adictionary
of which identical copies have been distributed to eachindividual
...
areindividualandmomentary. Inspeakingthereisonlythesumof
...
OF LANGUAGE
My
definition oflanguage presupposes the exclusion ofeverything
—
that is outside its organism or system in a word, of everything
known as "externallinguistics." Butexternallinguistics dealswith
—
many important things the very ones that we think of when we
begin the study of speech.
First and foremost come all the pointswherelinguistics borders
...
changes in an idiom by transportingitinto different surroundings.
All kinds of facts could be cited as substantiating evidence. For
instance, Norwayadopted Danishwhen sheunitedpoliticallywith
...
French) striveforlinguisticunity.Anadvancedstateofcivihzation
...
and allsorts ofinstitutions (the Church, the school, etc.). All these
...
steps the boundaries thatliterature apparentlymarks off; we need
...
languageand thevernacular;foreveryliterarylanguage, beingthe
productofthe culture, finallybreaksawayfromitsnaturalsphere,
the spoken language.
Finally, everythingthat relatesto thegeographical spreading of
...
issocloselylinkedtotheexistenceofanylanguage
;
butgeographi-
calspreadingand dialectalsplittingdonotactuallyaffecttheinner
...
hasbeenprevalentespeciallysincetheplacingofsomuchemphasis
...
gauge without considering their development. Is it possible to
...
I believethatthestudyofexternallinguisticphenomena ismost
...
from the outset that borrowingisnot a constantforcein the life of
a language. In certain isolated valleys there are dialects that have
nevertakenasingle artificialtermfrom the outside. Shouldwesay
...
gauge, ge — nerally speaking, is never — indispensable. For certain
...
way hindersusin studying these languagesinternally and learning
...
writer, forinstance, willgroup asheseesfitfacts about thespread-
ing of a language beyond its territory. If he looks for the forces
that createdaliterarylanguagebesidelocaldialects, he canalways
...
chess, whatisexternal can beseparatedrelativelyeasilyfromwhat
...
-'Pertainingto the study ofmonsters,' see p. 54, footnote. [Tr.]

---

GRAPHIC REPRESENTATION OF LANGUAGE 23
increasethe numberofchessmen, this changehas a profoundeffect
...
1. Needfor Studying the Subject
...
guages. Thelinguistisobligedtoacquainthimselfwiththegreatest
...
idioms that no longerexist. We would have direct texts at our dis-
posalin everyinstance onlyifpeoplehad always donewhatis now
...
period, peoplewrotetdten,fuolen, stozen;neartheendofthetwelfth
centurytheformstoten,fHelenappeared, butstozensubsisted. How
...
writingfor three centuries ; still, a slight trace had remained in the
...
Thuslanguagedoeshaveadefiniteandstableoraltraditionthat
...
1) First, thegraphicform ofwordsstrikesusasbeingsomething
...
2) Most people paymore attention to visual impressionssimply
...
governed byacode
;
the codeitselfconsists ofawrittensetofstrict
...
1) Inanideographicsystemeachwordisrepresentedbyasingle
signthatisunrelatedtothesoundsoftheworditself. Eachwritten

---

:
26 COURSE IN GENERAL LINGUISTICS
sign stands for a whole word and, consequently, for the idea ex-
pressed by theword. The classic example of an ideographic system
...
isolated sounds.
Thestatementthatthewrittenwordtendstoreplace thespoken
...
recommendedbytheInternationalPhoneticAssociation isroughlyasfollows
SAUSSURE IPA
...
must be examined.
4. Reasonsfor the Discrepancy between Writing and Pronunciation
...
century later. For a time people may change theirgraphic symbols
...
progressively. Finally, the practice ofjoiningdiscordant termshad
...
why should the French write mats 'but' andfait 'fact' when the
words are pronounced me andfef Why does c often have the value
...
essuyer 'wipe,' nettoyer 'clean'; butthewrittenformsofthesewords
...
used. TheMerovingiankingChilperictriedtoaddaspecialsymbol
...
The influence of etymology alsohelps towiden the gap between
...
X {dix 'ten'); andforkitusesc, qu, k, ch, cc, cqu (acquerir 'acquire').
Conversely, a single symbol stands for several values : t stands for
t or s, g for g or z, etc.^
"Indirect spellings" alsomeritourattention. Thereis no double
consonantin Zettel, Teller, etc.; German uses tt, II, etc. for the sole
...
vacillate at times
;
the result isfluctuatingorthographiesthat stem
fromeffortstorecordsoundsatdifferentperiods. Takeertha, erdha,
erda, or thrl, dhri, dri in Old High German: th, dh, d stand for the
samephonicelement.Butwhichelement?Writingdoesnotprovide
...
neighboring dialects show the spellingascafor aword in one of the
...
fightand bite;cstandsforthe same sound asboth s and k; etc. [Tr.]
...
odditytoanexceptionalpronunciation ofoandiisalsomisleading,
forthisimpUesthatlanguage depends onitswrittenform and that
certain hbertiesmay be taken in writing, asif the graphic symbols
were the norm.
False notions about the relationship between sound and graphic
symbolsappearevenin grammaticalrules, asin the case of French
...
'herring,' honte 'shame,' etc. Aslong as aspiration was used, words
...
;
said deu-z-ommes 'twomen,' Vomme 'the man.' For that period the
...
stands for a moment in itsenforced evolution. Precise laws govern
its evolution. Each step is determined by the preceding step. The
onlythingtoconsideristheonemostoftenforgotten
:
theevolution
of the word, its etymology.
The name of the town of Auch is o§ in phonetic transcription.
Thatisthe only FrenchwordinwhichfinalchstandsforI. Butwe
explainnothingbysaying, "Finalchispronounced5onlyinAuch."
The onlyquestionthatconcernsus isthis
:
Howcould Latin Auscii
have changed to o§? Orthography is unimportant.
Should Frenchgageure 'wager' be pronouncedwith o or ii? Some
speakers say : gazor, for heure 'hour' is pronounced dr. Others say
No, itisgazilr, forgeisequivalentz, asingedle 'jail.' Theargument
ispointless. Therealissueisetymological
:
gageurewasformedfrom
gager 'earn' justastournure 'figure' wasformedfromtourner 'turn';
onlygaziir isjustifiable;gazor is due solely to the equivocal nature
of writing.
But the tyranny of writinggoesevenfurther. By imposingitself
...
quently by Gilli6ron and Darmsteteras well asby Saussure. See note 6. [Tr.]

---

32 COURSE IN GENERAL LINGUISTICS
by speakers will probably increase. Some Parisians already pro-
nounce the t in septfemmes 'seven women';^^ Darmsteter foresees
...
fromitsnaturalfunctioning. Theyare duetoanexternal influence.
...
ofthewrittenwordrunstherisk ofperceivingonlyashapelessand
...
about thephysiology ofarticulatedsounds, were constantlyfalling
intoatrap ; tome, it meansafirststepin thedirection oftruth, for
thestudyofsoundsthemselvesfurnishes thedesiredprop. Modern
"The pronunciation [se] is now obsolescent. Cf. the trend toward pro-
nouncing the tin often. [Tr.]
'2Saussure'sterminologyisreminiscentofthebiologicalparlanceofGillieron
(e.g. in Pathologie ettherapeidiqueverbales, Paris, 1921). [Tr.]
'^Saussure later modifies and expands his definition of phonology (see
especially pp. 34, 42ff., 117ff. and 131). Only M. Grammont has followed
...
ofsoundsusedinspeaking,andphonemics(correspondingtoFrenchphonologie
...
isoftencalledphonetics (Frenchphonetique, GermanPhonetik)
.
To
me this name seems inappropriate. Instead, I shall use -phonology.
—
Forphoneticsfirstdesignated andshouldcontinuetodesignate
...
—
repeating isonlyanauxiliarydisciplineandbelongsexclusivelyto
...
constitutelanguage, andevenafterwehaveexplainedallthemove-
...
oflanguage. It isa system based on the mental opposition ofaudi-
...
Second, there should be some meansformaking a rigid distinction
...
linguists only. First, how would it bepossible tomake the English,
...
3. Validity ofEvidence Furnished by Writing
...
dealingwith thewrittenform throughwhichwemustpassin order
...
porarydescriptionsofthesoundsandpronunciationsoftheperiod.
...
anotherperiodisimportantin determiningthevalue ofthatletter.
Itspresentvalueis the resultofan evolution thatallowsus to cast
aside certain hypotheses from the outset. For instance, the exact
valueofSanskritqisunknown, butthefactthatitreplacedpalatal
Proto-Indo-European k clearly limits the field of conjecture.
Ifthehnguistknowsboththepointofdepartureandtheparallel
...
aresafeinassumingthatitalsoexistedduringtheprecedingperiod.
We do not know exactly what z standsfor in aword like Old High
German wazer; but our guideposts are the older form water on the
onehandand Modern German Wasser on the other. Thez must be
a sound half-way between t and s; we can reject any hypothesis
thatfailstoconsiderboth
t
ands;toholdthatzstandsforapalatal
...
consistsof (a) settingup thesystem ofsoundsasrevealedbydirect
...
letterispronouncedinthelanguagetheywishtodescribe. Byusing
...
beentaken, andphonologistshavemadeanimportantcontribution
...
[Forthispartwewere abletouseastenographicreproductionof
...
complete the datafurnished by Courses IandIII. (Editors'note.)]
...
beforephonologicalunitsarestudied; oureartellsuswhatb, t, etc.
...
pression, how can we say that infal, for instance, there are three
...
isnot the lengthofthesound (cf.fdlandfdl) butthequahty of the
...
sign always standsfor the same simple sound. The Greek alphabet
...
soundslike cand sfor s, no single signsfordouble s — oundslikexfor
ks. A one-to-one ratio between sounds and graphs the nece — ssary
andsufficientbasisforagood phonologicalsystem ofwriting was
...
BRBRS.
Delimitationofthesoundsofthespokenchaincanbebasedonly
...
1To be sure, they wrote X, 0, for kh, th, ph; <^EPO stands for ph^ro;
...
the situation is different: two real differencesin pronunciation were involved,
A; being sometime — s palatal and sometimes velar;—besides, koppa later dis-
appeared. Finally and this is a moresubtle point inearly Greek and Latin
inscriptions a double consonant is often indicated by a simple letter (e.g.
Latin fuisse, written FUI — SE) ; this is an infraction of the principle since the
...
;
respondstoagiven act: b (auditory beat) = b' (articulatorybeat).
...
Theelementsfirstobtained throughanalysisofthespoken chain
...
reduciblet, takenseparately, canbestudiedintheabstract, outside
...
2Cf
.
Sievers, Grundziige der Phonetik, fifth ed., 1902; Jespersen, Lehrbtich
...
singledoutare these : thelips aanda; the tongue jS y (/? designat-
ing the point and 7 the rest) the upper teeth d; the palate, made
;
up of the bony hard palatef-h in the front and the movable mem-
brain or soft palate i in the back; and, finally, the uvula 5.
...
timeswide, sometimesnarrow. When the openingiswide, allowing
...
principle used in setting up the table of phonemes below (see pp. 44ff.). But
we are merely carrying out Saussure's intent, and the reader may be assured
that these additions do not alter his thoughtin any way. [Ed.]
...
lips and tongue can beused to contract oreven to close the cavity.
...
gauge; in this respect, the laryngeal sound is uniform. Perceived
...
ertiesofphonemes. Inclassifyingphonemes,whatconstitutesthem
isofmuchlessimportancethanwhatdistinguishesthemfromeach
other. A negative force can be more important in classifying a

---

:
PHONOLOGICAL SPECIES 43
...
negativeforce, just as well as by its presence. Theimportant thing
is that two of the elements enumerated above are constant, and
that they are necessary and sufficient for the production ofsound
a) expiration
6) oral articulation;
...
We shouldalsobearinmindthataphonemeisidentifiedwhen
its
phonationalactisdetermined, andthatallspeciesofphonemeswill
...
Foreachphonemewemustdetermineitsoralarticulation, whether
a laryngeal sound is present (— -) orabsent ([ ]), andwhethernasal
resonanceispresent (….) orabsent ([ ]). Whenone ofthesethree
isunknown, theidentification ofasoundisincomplete. Butassoon
...
6 OralArticulation Oral Articulation OralArticulation OralArticulation
c
[ ] [ ]
d
[ ] [ ]
...
My
articulation. point of departure will be different. Regardless
ofwherearticulationtakesplace, thereisalwaysacertainaperture,
i.e., a certain degree of opening that rangesbetween two extremes,
complete closure and maximum opening. On that basis, and pro-
ceedingfrom minimum tomaximum aperture, soundswill fall into
seven categoriesthat I shalldesignate by the numbers0, 1,2, 3, 4,
...
Thenbyfocusingattention onlingualarticulation, itwouldalways
...
true is placed between a Greek letter (indicating an active organ)
...
aspirates ph, dh, etc.; the affricates t§, dz, pf, etc. ; palatalizedcon-
sonants;weakvowelslike 9 ormute e, etc.). Norshould oneexpect
...
theairtightbutbriefsealingoftheoralcavity. Thisisnottheplace
...
ofthetongueisplaced againstthefront of the palate
;
forthe third,
...
.
46 COURSE IN GENERAL LINGUISTICS
...
ThephonemesofClass B arecharacterizedbyincompleteclosure
...
the expulsion of air (Latinfricdre)
ThephonemesofClassB, unlikethoseofClassA,donotfallinto
three types. First, labials proper (corresponding to p and b) are
rarelyused ; I shalldisregard them ; theyare ordinarilyreplaced by
...
on making contact; without going into detail, I shalluse jS, 0', and
j8"todesignatethedifferentshapesofthetipofthetongue. Among
...
(1) In lateralarticulation (indicated by I in the formulas below)
...
(2) In vibrantarticulation (indicated byv intheformula below)
the tongue is heldfartherfrom the palate than for I, but a variable
...
Beyondaperture3, weenterintoanewfield
;
fromconsonantswe
pass to vowels. Up to this point, I have not brought up the dis-
tinction between the twoforaverysimplereason the phonational
:
mechanism is the same for both. The formula for a vowel is com-
parable in everyway to the formula for a voiced consonant. From
...
much of the larjmgeal soundis cut out depends on how tightlythe
mouth is closed; the wider the mouth is opened, the more noise
lessens; thus sound predominates in vowels through a purely
mechanical process.
E. Aperture 4: h u, ii
Thevowelsof Class E require muchmore closure than the other
—
vowels almostasmuchas consonants. Certain consequencesthat
...
however, thatthesoundswritteninanduninFrencharereallynot
...
The articulation of the phonemesofClassF correspondsexactly
to the articulation of i, u, ii. Nasalized vowels occur frequently
(e.g. French e, 6, o as in pin 'pine,' point 'bridge/ brun 'brown').
...
guistmaysimplyrecord thephenomenonwithouttryingtoexplain
...
nature and the order ofthephonemesinvolved sometimesavowel
;
...
byaliquidoranasal. Butwhatdoesthatprove?Aslongaswelook
...
quencesofphonemesasapoint ofdeparture, and thisissomething
else entirely. In the study of isolated sounds, to note the position
ofthevocalorgansissufficient
;
theacousticalqualityofaphoneme
...
groups, there should be a science ofsound thatwould treat articu-
...
andstopsthere, combinatoryphonologylimitsthepossibilitiesand
...
ofsonantsunlesswe givefull consideration to thelawsthatgovern
...
Doubtlesswe can single out, besidesimplosion and explosion, an
...
shallcallholdsorsistants. Buttheyarelikeimplosivearticulations,
...
prehensive treatment ofphonology, but it isjustifiable in a sketch
designedtoreducetheessentialsofsyllabicationtoassimpleaplan
...
stillquiteapparent
;
in aliawecandetectaclosingiandanopening
i: similarly, in auua, auua the implosive sound and the following
explosive sounddiffer sosharply thatwritingsometimes breaksits
...
thatin the articulation of/) is theresultoftwoforces: (1) the pressure ofair
againsttheopposingorgansand (2)theresistanceoftheorgansastheytighten
toequalizethepressure. A holdisthusonlycontinued implosion. Thatis why
...
this combination being clearly decomposable ; and if we considerit
...
nology, andtheimpossibilityofworkingwithabstractphonological
— —
...
To take stillanotherexample, inpronouncingfp I must firstestab-
lishclosureforr, then articulate an openingrwhile closure for p is
...
impression on the ear, allowing delimitation of the acousticalunits
...
least is notimportantin the chain ofphonemes. One must appreci-
ate this basic point fully in order to understand the developments
that follow.
3.
DifferentCombinationsofExplosionsandImplosionsinthe Chain
...
the spoken chain, we can alwaysjoin explosive and implosive pho-
nemes: kf, pi, yrh, etc. (e.g. Sanskrit kfta-, Enghsh pity, Proto-
Indo-European *yrhto-, etc.). Of course, some combinationshke kl,
etc. have no practical acoustical effect, but the fact remains that
thearticulatingofan openingkleavesthevocal organsin the right
...
Ofcoursethe successivearticulatorymomentsdonotfolloweach
other so naturally as they doin the reverse order of combination 1.
...
plosion. Forthatreason onemustalwaysresorttosomefacilitating
...
3) ImplosiveLink («) . Twoconsecutiveexplosionscanbepro-
...
missing: pk can bepronounced (pka), but these soundsdonotform
...
acousticaleffect of the first; thusthe organsare alreadyin position
for the r of price while p is being pronounced. But it is impossible
topronounce the reverse seriesrp, not because thisismechanically
...
true ofp, would beimperceptible. Twoseparate movementswould
^Tobe sure combinations ofexplosive phonemes having the same aperture
are very common in some languages (e.g. initial kt in Greek; cf. ktelno); al-
though these combinations are easy to pronounce, they lack acousticalunity.
...
rupted.
Acontinuousexplosivelinkmayincludemorethantwoelements
provided thateach successive aperture is wider than the preceding
...
link
:
wheneveraparticularphoneme ismore open than the follow-_
ing one, the impress — ion of continuity persists (e.g. if, ft); if this
conditionisnotmet ifthefollowingphoneme is more open orhas
—
...
alyzedin theexplosivelinkineveryway : inftthe i, byvirtue ofits
...
more than twoelementsifeachhaswideraperturethanthefollow-
ing one (cf. dfst).
Leaving aside the breaking of links, we turn now to the normal
— —
continuouschain onethatmightbetermedphysiological asrep-
...
articulation (whethervoicelessorvoiced, vibrantorlateral, etc.)- Conclusions
drawnfromtheprincipleofaperturealonearenotapplicablewithoutexception
toallactualcases. Inasequenceliketrya,forinstance, onlywithdifficultycan
...
make a perfectexplosive link (cf. also p. 63 concerning meurtrier, etc.); trwa,
...
tolerates absolutelyno hindrances. [Ed.]

---

PHONEMES IN THE SPOKEN CHAIN 57
pdfiikulyerrhd.^
resented by French particuUerement:
...
theik ofparticuUerement) Theregularcoincidence ofamechanical
.
...
division dfdfdnor the division dfdfd breaksthe chain, for both the
...
—
(>) e.g. artin artist—orfrom explosion toimplosion (<>) e.g. part
—
...
initial implosionsregardless of their phonological species, i.e., their
...
Vocalic peakshave alsobeen calledsonants, and allothersounds
...
thisismerelya coincidence
:
havingwideraperturethan any of the
...
5. Criticism of Theories ofSyllahication
The ear perceivessyllabic division in every spoken chain ; it also
perceives asonantin everysyllable. One can accept bothfactsand
still wonder why they should hold true. Different explanations
have been offered.
1) Noticingthatsome phonemesaremoresonorousthan others,
...
above, p. 52f., that y and w are nothing except i — and u) ; but one
whoaskswhyasoundshouldhaveadualfunction oradualacous-
—
...
"Cf. English/ee [fij] andfew [fju]. [Tr.]
...
syllable. Notonlyaresuch laws lacking, butthesonanticquahty is
described assilbenbildend, asiftheformation ofsyllablesdepended
on syllabic accent.
The difference between our method and (1) and (2) above is
obvious:byanalyzingsyllablesastheyoccurinthechain,wefound
...
andvocalic peak. Now we know the physiologicalconditionsunder
...
comprise two syllables, and it does have two if thelaryngealsound
...
sities. Determiningwhatiswilfulandwhatisphysiologicalisoften
difficult. But phonation depends on a succession ofimplosions and
explosions, and this is basic in syllabication.
6. Length ofImplosion and Explosion
...
(mater) andthoselongbyposition (factus). Why isfaccountedlong
infactus?because oftheatcombination?No, forifthecombination
alone determined length, every syllable beginning with two con-
sonants would also be long; but this is not true (cf. clients, etc.).
...
Besides, we know that vowelswhich occur before a combination
of an occlusive or fricative and a liquid are treated in two ways:
theainpatronmaybeeitherlongorshort
;
...
second creates a long syllable. The same dual treatment ofa is not
possible in a word hkefactus; ci can be pronounced, but ct cannot.
7. Phonemes ofAperture 4; Diphthongs; Questions about
Transcription
Finally, the phonemes of aperture 4 call for some additional
remarks. We have seen that, contrary to what happens with other
sounds,usagehassanctionedadoublesetofgraphs (w = u,u = H;
y = I, i = i) forthephonemesofaperture4 (seep. 53). Thereason
...
characteristicsofa consonant. [S.]

---

PHONEMES IN THE SPOKEN CHAIN 61
pretendingtoexplainthefact, I wishtopointoutthatconsonantal
...
oftheIspeciesdonotoccurindifferently. The sameremarksapply
...
lutely parallel; only the aperture ofthesecond elementis different.
...
thongs are not really diphthongs butexplosive-implosive combina-
...
combination.
—
Our definition of the diph — thong which relates it to the general
...
orimportance ; the important thing is to determine, not the end of
the sonant, but its beginning.
E,Sieversandmanyotherlinguistsmakeadistinctioninwriting
...
soundiscomposedofspeciesinjuxtaposition). Theirtranscription,

---

62 COURSE IN GENERAL LINGUISTICS
though based on oral evidence, is illogical and eliminates the very
distinction that should be made: (1) openingi,u{= y, w) are con-
...
sunewes, sunusu arestrictlyparallelintheirdualtreatmentof both
r andu. Inthesecondseriesatleast, the oppositionbetweenimplo-
sivesandexplosivesiscrystalclearinwriting.Butthetranscription
...
exampletoshowthatasinglesoundmayalternatelyfunctiontwice
as a sonant and twice as a non-sonant (actually n functions only
once asacon-sonant, and the word shouldbe transcribed heritrinn,,
but thatmatters little). Noexample would show more clearly that
"sound" and "species" are not synonymous. Forif we dwell on the
...
wewouldhavetopassfrom implosion (firstn) toexplosion (second
...
notbyplacing a "syllabic accent" on the ielement, but by chang-
...
and became a sonant uvfye -^ uvfye. An e subsequentlydeveloped
:
...
peak when at the beginning of the sentence orwhen the preceding
...
estatue (Standard Frenchsquelette 'skeleton,' statue 'statue') ; italso
...
;
meant of a prosthetic vowel.
4) It is scarcely necessary to come back to Indo-European so-
nantsand toask, forexample, whyOld High Germanhaglchanged
tohagalwhile balg remained intact. Here the /, the second element
...
avocalic peak. Beingsonantic, itdevelopedamore openprosthetic
vowel (an a if we accept spelling as evidence). The vowel became
less distinct with the passage of time, however, and todayHagelis
"Cf. Englishburglar. [Tr.]
...
Thisconception is open to criticism at severalpoints. Itassumes
thatready-made ideasexist before words (on this point, see below,
p. Ill) ; itdoesnot telluswhetheraname isvocalorpsychological
...
bothtermsinvolved in the linguistic sign are psychologicaland are
65
...
emphasized.
The linguisticsign unites, not a thingand a name, but a concept
...
impressionthatit makesonoursenses. Thesound-imageissensory,
andifIhappentocallit "material," itisonlyinthatsense, andby
wayofopposingittotheothertermoftheassociation, theconcept,
which is generally more abstract.
The psychological character of our sound-images becomes ap-
parentwhen we observe our own speech. Without moving our lips
ortongue, we can talk to ourselves or recite mentally a selection of
...
discourse. We can avoid thatmisunderstandingbyspeakingofthe
...
other. Whetherwe try tofind the meaning of the Latin word arbor
...
therepresentationofthesoundsofawordthereisalsothatofitsarticulation,
themuscularimageofthephonationalact. Butfor F. deSaussurelanguageis
essentiallyadepository, athingreceivedfromwithout (seep. 13). Thesound-
image is par excellence the natural representation of the word as a fact of
potentiallanguage, outside any actualuseofitin speaking. Themotorside is
...
;
NATURE OF THE LINGUISTIC SIGN 67
clearthatonlytheassociationssanctionedbythatlanguageappeal
...
\signi££d^[signifie] and signifier [signifiant] the last twotermshave
;
...
regardssign, ifI am satisfiedwithit, thisissimplybecause I donot
...
istics. Inenunciatingthem I am alsopositingthebasicprinciplesof
any study of this type.
2. Principle I: The Arbitrary Natureofthe Sign
The bond between the signifier and the signified is arbitrary.
Since I mean by sign thewhole that resultsfrom the associatingof
...
thesuccessionofsoundss-6-rwhichservesasitssignifierinFrench
...
No one disputesthe principle of the arbitrarynature of the sign,
...
ascience, thequestionwillarisewhetherornotitproperlyincludes
...
thearbitrarinessofthesign. In fact,everymeansofexpressionused
—
in society is based, in princ — iple, on collective behavior or what
...
ness (asin the case ofa Chinesewho greets hisemperor by bowing
down to the ground nine times), are nonetheless fixed by rule; it is
thisruleandnottheintrinsicvalue ofthegesturesthatobliges one
touse them. Signs that arewholly arbitrary realizebetterthg,n the
others the ideal of the semiological process; that is why langu^^,
themostcomplexand^universalofallsystems ofexpression, is also(r
...
and the signified. The symbol ofjustice, a pair of scales, could not
be replaced by just any other symbol, such as a chariot.
The word arbitrary also callsfor comment. The term should not
...
linguisticcommunity) ; I meanthatitisunmotivated, i.e. arbitrary
in that it actually has no natural connection with the signified.
In concludingletusconsidertwoobjectionsthatmightberaised
...
neverorganicelementsofalinguisticsystem. Besides, theirnumber
...
weneedonlyexaminetheirLatinforms (fouetisderivedfromfdgus
'beech-tree,' glasfromdassimim 'sound ofa trumpet'). The quahty
...
etc.), notonly are theylimitedin number, but also theyare chosen
somewhat arbitrarily, for they are only approximate and more or
less conventional imitations ofcertain sounds (cf English bow-bow
.
andFrenchouaoua). Inaddition, oncethesewordshavebeenintro-
...
assume that ofthelinguistic sign in general, whichisunmotivated.
...
realitydictated, so tospeak, by natural forces. But foremost inter-
...
gauge to the next (e.g. the English equivalent of French ate! is
ouch!). We know, moreover, that many interjections were once

---

70 COURSE IN GENERAL LINGUISTICS
words with specific meanings (of. French disable! 'darn!' mordieu!
...
Sometimesthelinearnatureof thesignifierisnot obvious. When
I accent a syllable, for instance, it seems that I am concentrating
morethanonesignificantelementonthe samepoint. Butthisisan
illusion
;
the S3'^llableanditsaccentconstitute onlyone phonational
...
p. 131).
*Cf. Englishgoodness! and zounds! (from God's wounds). [Tr.]
...
to the linguistic community thatuses it. The masseshave no voice
in the matter, and the signifier chosen by language could be re-
placed by no other. Thisfact, which seemstoembody a contradic-
...
Letusfirstseewhywecannotcontrolthelinguisticsignandthen
draw together the important consequences that issue from the
phenomenon.
No matter what period we choose or how far back we go, lan-
We
gauge always appears as a heritage of the preceding period.
might conceive ofan actbywhich, at agiven moment, nameswere
...
No society, in fact, knowsorhaseverknownlanguageotherthan
...
weightthan those of the second. Finally, comingback tolanguage,
we must askwhythe historicalfactor oftransmission dominatesit
...
true, but fuse and interpenetrate, each generation embracing in-
dividualsofall ages—withtheresultthatmodificationsoflanguage
...
it might be added that reflection doesnotenterinto the active use
—
of an idiom speakers are largely unconscious of the laws of lan-
gauge; and if they are unaware of them, how could they modify
...
The foregoingconsiderationsare important but not topical. The
...
1) Thearbitrarynatureofthesign. Above, wehad toacceptthe
...
fromanyattempttomodify it. Even ifpeopleweremore conscious
oflanguagethantheyare, theywouldstillnotknowhowtodiscuss
it. The reason is simply that any subject in order to be discussed
musthaveareasonable basis. Itispossible, forinstance, todiscuss
whetherthemonogamousformofmarriageismorereasonable.than
...
\ bolhasarationalrelationshipwith the thing signified (see p. 68)
butlanguageis a system ofarbitrary signs and lacks the necessary
)
;
...
Anotherimportantdeterrent tolinguistic changeis the great num-
...
it becomes apparent. The system is a complex mechanismthatcan
...
—
4) Collectiveinertiatowardinnovation. Language andthiscon-
—
...
only a certain number ofindividualssimultaneously and then only

---

74 COURSE IN GENERAL LINGUISTICS
duringalimitedperiodoftime;inlanguage, onthecontrary,every-
one participates at all times, and that is why it is constantly being
influencedbyall. Thiscapitalfactsufficestoshowtheimpossibility
of revolution. Of all social institutions, language is least amenable
to initiative. It blendswith the life of society, and the latter, inert
...
alwaystheheritage ot theprecedingperiod,wemustaddthatthese
socialforces are linkedwith time. Language is checkednot only by
...
—
antitheticalforces arbitraryconventionbyvirtue ofwhichchoice
...
can speak ofboththeimmutabilityandthemutabilityofthesign.'
...
First, let there be nomistake about the meaning that we attach
...
twostrikingterms,hewantedonlytoemphasizethefactthatlanguagechanges
in spite of the inability of speakers to change it. One can also say that it is
intangible butnot unchangeable. [Ed.]
...
phonetic changesundergone by the signifier, orperhaps changesin
...
Herearesomeexamples. Latinnecare 'kill' becamenoyer 'drown'
...
Teil 'part' isnolongerimplied;Drittelisasimpleword. In oneway
or another there is always a shift in the relationship.
In Anglo-Saxon the preliteraryformfot 'foot' remainedwhile its
...
[forceswhichfrom onemoment to thenextareshiftingthe relation-
...
—
areallbasedinvaryingdegreesonthenaturalrelationsofthings
...
can change anythingin it, and on the otherhand, the arbitrariness!
...
itis notin circulation ; from the momentwhen itfulfillsitsmission
...
IMMUTABILITY AND MUTABILITY OF THE SIGN 77
...
and speaking. Language is speech lessspeaking. It is the whole set
of linguistic habits which allow an individual to understand and
to be understood.
2) But this definition stillleaveslanguage outside itssocialcon-
...
inner characteristics. Its complete definition confrontsuswith two
inseparable entities, as shown in this drawing:
—
But under the conditions described language is not living it
has only potentiallife; we have considered only the social, not the
historical, fact.

---

78 COURSE IN GENERAL LINGUISTICS
3) The linguistic sign is arbitrary; language, as defined, would
therefore seemtobeasystemwhich, becauseitdependssolelyon a
...
reason in actual contactsbetween individuals. But the thingwhich
keeps language from being a simple convention that can be modi-
field at the whim of interested parties is not its social nature ; it is
...
ofthesocialforcesthatinfluencelanguage. Torepresentthe actual
...
necessarilyimplieschange, varyingdegreesofshiftsintherelation-
...
1. Inner Duality ofAll Sciences Concerned with Values
...
;
producesno special effects in them. Astronomyhas found that the
...
has its descriptive science andits historical science; no one opposes
one to the other. The political history of states is unfolded solely
in time, but ahistoriandepictingaparticularperiod does notwork
apartfrom history. Conversely, the science ofpoHticalinstitutions
...
appeared on these subjectspoint up the distinction. Proceeding as
—
they have, economists are without being well aware of it
obeying an inner necessity. A similar necessity obligesus to divide
linguistics into two parts, each with its own principle. Here as in
political economywe are confronted with the notion ofvalue; both
sciences are concerned with a systemfor equating things ofdifferent
—
...
theco-ordinatesalongwhichtheirsubjectmatterisaligned. Every-

---

80 COURSE IN GENERAL LINGUISTICS
...
T
D
For a science concerned withvaluesthe distinctionis a practical
necessity and sometimes an absolute one. In these fields scholars
cannot organize theirresearch rigorouslywithout considering both
coordinates and making a distinction between the system of
values per se and the same values as they relate to time.
Thisdistinctionhastobeheededbythelinguistaboveallothers,
...
relations, ashappenswitheconomics (thevalueofaplotofground,
—
...
to study it according to both coordinates. No other system em-
...
Thereasonsfordistinguishingtwosciences oflanguageareclear.
How should the sciences bedesignated? Available terms donot all
bringoutthedistinctionwithequalsharpness. "Linguistichistory"
and "historical linguistics" are too vague. Since political history
includesthedescriptionofdifferentperiodsaswellasthenarration
of events, the student might think that he is studying a language
accordingtotheaxisoftimewhenhedescribesitssuccessivestates,
...
evolutionary phase.
2. Inner Duality and the History ofLinguistics
The first thing that strikes us when we study the facts of lan-
gauge is that their succession in time does not exist insofar as the
...
He can enter the mind ofspeakers only by completely suppressing
the past. Theintervention ofhistory can onlyfalsify his judgment.
...
philologyuses the materials at hand to reconstruct hypothetically
an older type of language; comparison is but a means of recon-
structingthepast. Themethodisthesameinthenarrowerstudy of
subgroups (Romance languages, Germanic languages, etc.); states
intervene only irregularly and piecemeal. Such is the tendency
introducedbyBopp. Hisconceptionoflanguageisthereforehybrid
and hesitating.
Against this, what was the procedure of those who studied lan-
gauge before the beginning of modern linguistics, i.e. the "gram-
marians" inspiredbytraditionalmethods? Itiscurioustonotethat
...
example, attemptstodescribethestateofFrenchunderLouisXIV
...
recordingfacts ; it lacks overall perspective ; often it isunable even
...
methodwillinturngive abetterunderstanding oflanguage-states.
The old grammar saw only the synchronic fact; linguistics has
revealed a new class of phenomena; but that is not enough; one
must sense the opposition between the two classes offacts to draw
...
static, for it concerns the relation between two coexistingforms of
...
Later thefinal-iproduced an umlaut, i.e. it resultedin the chang-
ing of the a of the preceding syllable to e: gasti—^ gesti; hanti -^
—
henti. Then the final-ilostits timbre:gesti >geste, etc. The result
is that today German has Gast: Gdste, Hand: Hdnde, and a whole
group ofwordsmarkedbythesamedifferencebetweenthesingular
...
one, the fall of final -i, feti becamefet; after that, fot had as its
pluralfet; td]>, te\>; gos, ges, etc. (Modern Englishfoot:feet, tooth:
teeth, goose: geese.)
Previously, when speakers used gast: gasti, fot: foti, the simple
addition of an i marked the plural; Gast: Gaste andfot:fet show a
new mechanism for indicating the plural. The mechanism is not
the same in bothinstances; in Old English thereis only opposition
...
1) In noway do diachronicfactsaim tosignal avalue bymeans
ofanothersign thatgastibecamegesti, geste {Gaste) hasnothingto
;
do with the plural of substantives ; in tragit-^ tragi, the same um-
lautoccursinverbalinflection, andsoforth. A diachronicfactisan
...
system. Speakersdid notwish topass from one system ofrelations
toanother;modificationdoesnotaffectthearrangementbutrather
its elements.
...
to another system.
3)
Theforegoingobservationpointsuptheeverfortuitousnature
...
the contrary thatthe statewhichresultedfrom the changewasnot
...
lar and plural; fot: fet is no better for this purpose thanfot: *foti.
...
NotGastealonebutthe opposition Gast: Gdsteexpressestheplural.
The diachronic fact isjust the opposite: only one term isinvolved,
and for the new one to appear (Gdste), the old one (gasti) must
first give way to it.
Totrytounite such dissimilarfactsin the samedisciplinewould
certainly be a fanciful undertaking. The diachronic perspective
dealswithphenomenathatare unrelated tosystemsalthoughthey
do condition them.
Herearesomeotherexamplestostrengthenandcomplementthe
conclusions drawn from the first ones.

---

86 COURSE IN GENERAL LINGUISTICS
In French, the accent alwaysfalls on the last syllableunless this
...
relationsthatareinnowayanalogoustotheFrenchlaw. Doubtless
the accent is the same in the sense that it remained in the same
position
;
in French
—
wordsit alwaysfalls on the syllable thathad it
...
systems, toapplyanewformula, sinceinwordslikeamtcum — ^ ami
...
representativesofProto-Indo-Europeani andm, havedisappeared.
Czech, for example, has slovo, slovem, slova, slov; Ukewise zena
'woman' accusativesingularzenu, nominativepluralzeny, genitive
:
We
plural zen. Here the genitive {slov, zen) has zero inflection. see
...
forms. Itseemsstrangeat firstglancethat such aparticularnotion
...
Allthisconfirmstheprinciplespreviouslystated. Tosummarize:
Languageisasystemwhosepartscanandmustallbeconsidered
...
quentlyproduceonthewholesystem. Thebasic differencebetween
...
4. TheDifference betweenthe Two ClassesIllustrated by Comparisons
To show both the autonomy and the interdependence of syn-
chronywe can compare the first to the projection of an object on a
plane surface. Anyprojection dependsdirectly on the nature of the
—
object projected, yet differs from it the object itself is a thing
apart. Otherwise therewouldnotbe awholescience ofprojections;
consideringthebodiesthemselveswouldsuffice. Inlinguisticsthere
...
of bodies.
Similarlyif the stem of a plantis cut transversely, arather com-
...
—
:
88 COURSE IN GENERAL LINGUISTICS
tween the fibers—relations that we could never grasp by viewing
the longitudinal plane.
But ofallcomparisonsthatmightbeimagined, the mostfriutful
istheonethatmightbedrawnbetweenthefunctioningoflanguage
...
First, astate ofthesetofchessmencorrespondscloselytoastate
...
above all else on an unchangeable convention, the set ofrules that
existsbeforeagamebeginsandpersistsaftereachmove. Rulesthat
are agreedupon once andforallexist in language too; they are the
...
(a) In each play only one chesspiece is moved ; in the sameway
...
system; it is impossibleforthe player to foresee exactly the extent
...
(c) Inchess, eachmove isabsolutelydistinctfromthepreceding
...
followedthe entirematch hasno advantage overthe curious party
whocomesupatacritical momenttoinspectthestateofthegame
...
state, and the changesthatintervenebetween stateshave noplace
in either state.
At only one point is the comparison weak: the chessplayer
intendsto bringabouta shiftandtherebytoexertanaction on the
system, whereas language premeditatesnothing. The pieces oflan-
—
gauge are shifted or rather modified—spontaneously and for-
...
rise to verbal forms hke tragifrom tragit, etc. In order tomake the
game ofchessseem at everypointlike thefunctioning oflanguage,
...
diachronic facts cannot be reduced to the synchronic systemwhich
...
are not ofequal importance. Here it isevident that the synchronic
...
but thisonlygoestoprove clearlythat diachroniclinguisticsisnot
an end in itself. What is said of journalism applies to diachrony:
it leads everywhere if one departs from it.
Themethods ofdiachronyand synchrony also differ, andin two
ways.
...
aduphcationinmethodologywithwhichweshalldealinPartFive.
...
Any notionwillpointup thistruth. The synchronic anddiachronic
...
pasisidenticaltothe substantivepas 'step,'whereasthetwo forms
...
apriorithatitisgovernedbyprescriptionsanalogoustothosethat
control communities. Now every social law has two basic charac-
teristics: it is imper — ative and it is general; it comes in by force and
it covers all cases within certain limits of time and place, of
course.
Do the laws of lang — uage fit this definition? The first step — in
...
3. Allwordsendin a vowel or in s, n, orr, to the exclusion ofall
other consonants.
4. Prevocalic initial s became h (sign of aspiration) : *septm
(Latin septem) -^heptd.
m —
5. Final changed to n: *jugom * zugon (cf. Latinjugum).^
6. Final occlusives fell: *gunaik -^gunai, *epherst—^ ephere,
*epheront -^ epheron.
Law 1 isdiachronic dhbecameth,etc. Law2expressesarelation
:
between the word-unit and accent, a sort of contract between two
coexisting terms ; it is a synchronic law. The same istrueofLaw3
since it concernstheword-unit and itsending. Laws 4, 5, and 6 are
...
Afterweseparate thetwoclassesoflaws, weseethatLaws2and
...
ofspeakers. I mean thatin languagenoforce guarantees the main-
...
Gauthiot {Lafin du mot indo-europeen, pp. 158ff.), final -m did not exist in
...
preservation ofa formerstateis thesamein nature as the one thatmanifests
...
which an effectis produced, a thingexecuted. Butthisimperative-
...
meaning 'piece ofwood, rafter' isdue to particularcauses and does
notdependon otherchanges thatmighthave occurred at the same
...
appearance naturally caused awhole series offorms to vanish. For
...
Basically, however, there is but one phenomenon, and thishistori-
caleventisjust asisolatedinits own order asthe semantic change
undergone by poutre. It takes on the appearance of a "law" only
becauseitisrealizedwithin asystem. Therigidarrangementofthe
...
example. Law 1 on page92 {*dhumos —^ Greek thumos) affects all
—
Greek words containing a voiced aspirate (cf. *nebhos » nephos,
*medhu — ^methu, *anghd -^dnkho, etc.)
;
Law 4 {*septm -^ heptd)
...
p. 97) orbytheinterferenceoffactsofanotherclass (analogy,etc.).
...
phonetic law holds, allfacts embraced byit are butmanifestations
of a single particular fact.
The real issue is to find out whether phonetic changes affect
v;ords or only sounds, and there is no doubt ab — out the answer: in
...
observation that thesetransformationsarebasicallyalien towards
...
transformationsof Greekocclusives byprogressiveweakeningof theirarticu-
lation (seeMem. delaSoc.deLing., IX, pp. 163ff.). Naturallytheconclusions
...
definedabove, andifone stillwishestospeakoflinguisticlaws, the
...
Butcannotthetermalsobeusedinlanguageasinthephysicaland
...
thereisnopanchronicviewpoint. Each phonetic change, regardless
...
A
doesnot. concretefactthatlendsitselftopanchronicexplanation
...
itstandsin opposition toeveryword thatmightbeassociatedwith
...
theyhavenolinguisticvalue. Evenfromthe panchronicviewpoint
-gz, consideredinachainlikeiin§ozodmirahld'anadmirablething/
isnot aunit but ashapeless mass; indeed, why ^oz rather than oza
or nsof It is not a value, for it has no meaning. From the pan-
chronic viewpoint the particular facts of language are never
reached.
8. Consequences of the Confusing ofSynchrony and Diachrony
Two instances will be cited
(a) Synchronic truth seems to be the denial of diachronic truth,
and onewhohasasuperficialview ofthingsimaginesthat achoice
...
granmiarinthename ofhistoricalgrammar? No, forthatwouldbe
seeing only half ofthefacts; one must not think that the historical
...
elements, but in the collective mind of the community ofspeakers,
these are drawn together andfusedinto one. The synchronic truth
is just as absolute and indisputable as the diachronic truth.
(b) Synchronictruthissosimilartodiachronictruththatpeople
...
bysayingthatLatinpatermeantthesamething.Anotherexample
Latin short a becameiin noninitial open syllables; beside/acio we
have conficio, beside amicus, inimicus, etc. The law is often stated
in this way: ''The a offacio becomes i in conficio because it is no
longer in the first syllable." That is not true: never did the a
"become"iinconficio. Tore-establishthetruthonemust —singleout
two periods and four terms. Speakers first said facio confacio;
then, confaciohavingbeen—changedtoconficiowhilefacioremained
unchanged, they saidfacio conficio:
A
facio < > confacio Period
facio < > conficio Period B
Ifa "change" occurred, itisbetween confacio andconficio; butthe
rule, badly formulated, does not even mention confacio! Then be-
sidethediachronicchangethereisasecondfact,absolutelydistinct
from the first and having to do with the purely synchronic op-
position betweenfacio and conficio. One is tempted to say that it
isnot a fact but a result. Nevertheless, it is afactin its own class;
indeed, all synchronic phenomena are like this. The true value of
the oppositionfacio: conficio is not recognized for the very reason
that the opposition is not very significant. But oppositions like
Gast:Gdsteandgebe:gibt, thoughalsofortuitousresultsofphonetic
...
closelylinked, eachconditioningtheother, pointstotheconclusion
...
explain Greekphuktos, for example, it might seem sufficient to say
thatin Greek g orkh became k before voiceless consonants, and to
...
otheraspirateinthesamewordwaschangedintoan occlusive, and
...
thecommunity, becameafact oflanguage. Butnotallinnovations
...
wayinvalidatesbut ratherstrengthensthe distinction made above
sinceinthehistory ofanyinnovationthere are alwaystwodistinct
moments: (1) when itsprang up in individualusage; and (2) when
...
One must recognize that the ideal, theoreticalformofascienceis
...
;
dominatesinlinguisticresearch. Even ifthedistinctionssetuphere
wereacceptedonceandforall, apreciseorientation probablycould
not be imposed on investigations in the name of the stated ideal.
In the synchronic study of Old French, forinstance, the hnguist
workswithfacts and principles that havenothing in common with
...
wouldberevealedin the description ofan existingBantulanguage,
...
pare in ordertoestablish the general truths of the diachronic class.
...
a profound unity. Whicheverway we look in studying a language,
...
bindtogethersuccessivetermsnotperceivedbythecollectivemind
...
ofanylanguage-state. Many oftheitemsalreadyexplainedin Part
Onebelongrathertosynchrony forinstance,thegeneralproperties
;
...
whicharetheprovinceofgrammarareestablished. Inthefollowing
...
thanthestudyofhistoricallinguistics. Evolutionaryfactsare more
concreteandstriking theirobservablerelationstietogethersucces-
;
sivetermsthatareeasilygrasped ;itiseasy, oftenevenamusing, to
...
somewhat in spite ofeverything, studying a language-state means
...
Politicalhistorymakesadistinctionbetweenera,apointintime,
...
ingthosetimes.Onemightalsosaythatstaticlinguisticsdealswith
eras. But state is preferable. The beginning and the end of an era
aregenerallycharacterizedbysomeratherbrusquerevolution that
tends to modify theexistingstate of affairs. Theword state avoids
giving the impression that anything similar occurs in language.
Besides, preciselybecauseitisborrowedfromhistory, thetermera
...
1)
Thelinguisticentityexistsonlythroughtheassociatingofthe
...
THE CONCRETE ENTITIES OF LANGUAGE
103
meant is retained, the entity vanishes; instead of a concrete object
...
whichcanexistinspacewithoutbecomingconfused, andtoassume
...
^
104 COURSE IN GENERAL LINGUISTICS
...
delimited signs that need onlybe studied according to theirmean-
ing and arrangement ; it is a confusedmass, and only attentiveness
andfamiliarizationwillrevealitsparticularelements. Theunithas
no special phonic character, and the only definition that we can
giveitisthis:itisasliceofsoundwhichtotheexclusionofeverything
that precedes andfollows it in the spoken chain is the signifier of a
certain concept.
2. Method ofDelimitation
Onewhoknowsa language singles outitsunitsby avery simple
—
method in theory, at any rate. His method consists of using
speakingasthe sourcematerialoflanguageand picturingit astwo
...
B
b'
Take Frenchsizlapra. Canwe cutthe chain after I andmake sizl
...
divisions are these: (1) si-z-la-pra (sije la prends 'if Itakeit') and
(2) si-z-l-apra (sije Vapprends 'if I learn it'), and they are deter-
mined by the meaning that is attached to the words.
Toverify the result of the procedure and be assured thatwe are
really deahngwithaunit, wemust be able in comparingaseries of
*Cf. thesounds [jurmam] in English: "yourmine" or "you'remine." [Tr.]

---

THE CONCRETE ENTITIES OF LANGUAGE 105
sentences in which the same unit occurs to separate the unit from
the rest of the context and find in each instance that meaningjus-
tifies the delimitation. Take the two French phrases lafprsdiiva
(la,force du vent 'theforce of the wind'), and abudfgrs (a bout de
force 'exhausted'; literally: 'at the end of one's force'). In each
phrase the same concept coincideswith the same phonic sHce,fgrs;
thus it is certainly a linguistic unit. But in ilmdfgrsaparle (il me
force a parler 'heforces me to talk') fors has an entirely different
meaning: it is therefore another unit.
3. Practical Difficulties ofDelimitation
...
we may say that the analysis of the spoken chain sizlaprdresulted
in the delimitingoffourunits, andthattheunitsarewords :si-je-l-
...
Tobe convinced, weneed onlythink ofFrenchcheval 'horse' and
its pluralfrom chevaux. People readily say that they are twoforms
...
twoforms of the same word, and there is no question of a concrete
unit. The meaning is the same, but the slices of sound are dif-
ferent. As soon as we try to liken concrete units to words, we
—
face adilemma:we musteitherignore the relation whichisnone-
—
...
complexunits, andwe caneasilysingle outtheirsubunits (suffixes,
...
function. Conversely,someunitsarelargerthanwords:compounds
(Frenchporte-plume 'penholder'),locutions (s'ilvousplait'please'),
inflectedforms {ila ete 'he hasbeen'), etc. Buttheseunitsresistde-
...
delimitingunits. Anythingthatis ofeven the slightestsignificance
seems like a concrete element to them and they neverfail to single
...
sentencesthatcouldbeuttered, theirmoststrikingcharacteristicis
that innowaydotheyresembleeachother. We areatfirsttempted
tolikentheimmensediversityofsentencestotheequaldiversityof
...
againwefind, withouthavinglookedforit, thewordwithitsgram-
matical characteristics andthus fall back into the same difficulties
as before.
4. Conclusion
Inmostsciencesthequestion ofunitsneverevenarises theunits
:
...
space, thestars. Thechemistcanstudythenatureandcomposition
of potassium bichromate without doubtingfor an instant that this
is a well-defined object.
Whenasciencehasnoconcreteunitsthatareimmediatelyrecog-
nizable, it is because they are not necessary. In history, for ex-
ample, is the unit the individual, the era, orthenation? We donot
...
singlestep withoutcomingbacktothem; and still, delimitingthem
...
linguistics depends directly on our conception of the unitand even
blends w^ith it. This is what I should like successively to dem-
onstratewith respect tothenotions ofsynchronicidentity, reality,
and value.
A. What isasynchronicidentityf Hereitisnotaquestionofthe
...
but rather of the equally interestingidentitybyvirtue ofwhichwe

---

;
108 COURSE IN GENERAL LINGUISTICS
state that two sentences like je ne says jpas 'I don't know' and ne
...
sound and concepts is proof of identity (see above, p. 105, laforce
du vent a bout de force) the reverse is not true. There can be
: ,
identitywithoutthiscorrespondence. When Gentlemen!isrepeated
...
identity (cf. French adopterunemode 'adoptafashion' and adopter
un enfant 'adopt a child,' la fleur du pommier 'the flower of the
apple tree' and la,fleur de la noblesse 'theflower of nobility,' etc.).
...
takenfromoutsidespeech. Forinstance,wespeakoftheidentityof
two "8:25 p.m. Geneva-to-Paris" trains that leave at twenty-four
houri
—
ntervals. We feelthatitisthesametr
—
aineachday,yetevery-
thing the locomotive, coaches, personnel is probably different.
Or ifastreetis demolished, then rebuilt, we say thatit isthesame
...
itisbasedoncertainconditionsthataredistinctfromthematerials
...
thatfittheconditions, e.g. itslocationwithrespecttootherstreets.
...
cannot conceive ofastreet or train outsideitsmaterialreahzation.
Let us contrast the preceding examples with the completely
different case of a suit which has been stolen from me andwhich I
findinthewindowofasecond-handstore. Herewehaveamaterial
—
...
phonicactandanewpsychologicalact. The bondbetween the two
...
Take as an example the distinction between the parts ofspeech.
...
principle that is applied to grammarfromwithout like the degrees
...
words. Nowthedistinctionbetweenpartsofspeechisexactlywhat
...
sification thedivisionofwordsintosubstantives,verbs,adjectives,
;
etc. is not an undeniable linguistic reality.'
Linguisticsaccordinglyworkscontinuouslywithconceptsforged
...
But how canwe find out? And ifthey are phantoms, what realities
...
nee^S'fui' uiianglilgall fheTaCts^'Tts disposaly(5n the ofheiTi
—
and^"'^
^.torbase the classifications on anythingexcept concrete entities to
...
pp. 88 ff.). Take aknight, for instance. By itself is it a — n element in
...
theplayer; itbecomes a real, concreteelement onlywhen endowed
withvalue andwedded to it. Suppose that the piece happens to be
...
semiologicalsystemslikelanguage, whereelementsholdeachother
inequilibriuminaccordancewithfixedrules, thenotion ofidentity
blends with that of value and vice versa.
In aword, that is why the notion of value envelopes the notions
ofunit, concreteentity, andreality. But ifthereisnofundamental
*Form, function, andmeaningcombinetomaketheclassingofthepartsof
speech even more difficult in English than in French. Cf. ten-foot: tenfeet in
aten-footpole: thepoleistenfeet long. [Tr.]
...
back tothecentralquestionthatdominatesall ofstatic linguistics.
Itwould be interestingfrom a practical viewpoint to begin with
units, todeterminewhattheyareandtoaccountfortheirdiversity
by classifying them. Itwould be necessary to search for the reason
—
...
centralin the mechanism oflanguage but that is a subjectwhich
...
nomena to theirfundamental principle. It cannot be said that this
...
Still, in spite oftheir capitalimportance, itisbetter toapproach
the problem of units through the study ofvalue, forin my opinion
...
ideas and sounds.
—
Psychologically ourthought apartfromitsexpression inwords
—
...
signswewouldbeunabletomakeaclear-cut, consistentdistinction

---

:
112 COURSE IN GENERAL LINGUISTICS
...
substancedividedinturnintodistinctpartstofurnishthesignifiers
needed by thought. The linguistic fact can therefore be pictured
— —
initstotality i.e. language asaseriesofcontiguoussubdivisions
...
Thecharacteristicroleoflanguagewithrespecttothoughtisnot
to create a materialphonic meansforexpressingideas but to serve
...
waterwillbe brokenupinto aseries ofdivisions, waves;thewaves
resemble the union or coupUng of thought with phonic substance.
Language might be called the domain ofarticulations, usingthe
...
isthefrontandthesoundthe back; one cannot cutthefrontwith-
...
sound and thought combine their combinationproduces aform, not
;
a substance.
These viewsgive abetterunderstanding ofwhatwassaidbefore
(seepp. 67ff.) aboutthearbitrarinessofsigns. Notonlyarethetwo
domains that are linked by the linguistic fact shapeless and con-
fused, but the choice of agiven slice ofsound toname a given idea
is completely arbitrary. If this were not true, the notion of value
would be compromised, foritwould include an externally imposed
...
In addition, the idea ofvalue, as defined, showsthatto consider
atermassimplytheunionofacertainsoundwithacertainconcept
...
specimensequivalenttorealtermsin asynchronicsystem, and the
principles that we evolve with respect to words will be vaUd for
entities in general.
2. Linguistic Valuefrom a Conceptual Viewpoint
Whenwespeakofthevalueofaword,wegenerallythinkfirstof
...
somuchfromtheirsimilarityasfromthesubtletyofthedistinction
that they mark.
...
pendentuponvalue and stillbe distinctfrom it. Butwemust clear
up the issue or risk reducing language to a simple naming-process
(see p. 65).
Letusfirsttake signification asitisgenerallyunderstoodandas
itwaspicturedonpage 67. Asthearrowsin thedrawingshow, itis
only the counterpart of the sound-image. Everything that occurs
concernsonlythesound-imageand the conceptwhenwelookupon
the word as independent and self-contained.
Buthereistheparadox
:
on theonehand theconceptseemstobe
thecounterpartofthesound-image, andonthe otherhandthesign
...
again takinguptheexample of the sheetof paperthatiscutin two
—
(seep. 113) itisclearthattheobservablerelationbetweenthedif-
...
determine what a five-franc piece is worth one must therefore know
(1) thatitcan beexchangedforafixedquantityofadifferentthing,
e.g. bread; and (2) that it can be compared with a similarvalue of
...
forsomething dissimilar, an idea ; besides, it can be comparedwith
something of the same nature, anotherword. Its value is therefore
...
e.g. to grammaticalentities. Thevalue ofa French pluraldoesnot
...
of two {myeyes, my ears, myarms, my legs, etc. are dual);*itwould
be wrong to attribute the same value to the plural in Sanskrit and
in French;itsvalue clearlydepends on whatis outside and around
it.
...
*Theuseofthecomparativeformfortwoandthesuperlativeformorethan
...
LINGUISTIC VALUE 117
distinctionsbetween thepast, present, andfuture. Proto-Germanic
has no special form for the future; to say that the future is ex-
pressed by the present is wrong, for the value of the present isnot
thesameinGermanic asinlanguagesthathaveafuturealongwith
the present. The Slavic languages regularly single out two aspects
oftheverb theperfectiverepresentsaction as apoint, completein
:
...
the system. When they are said to correspond to concepts, it isI
understood that the concepts are purely differential and defined!
notby theirpositive content butnegatively bytheirrelationswith
the other terms of the system. Their most precise characteristic Uj
in being what the others are not.
Now therealinterpretation ofthediagramofthesignalbecomes
apparent. Thus
meansthatinFrenchtheconcept "tojudge"is-iinketdtothesoundU--^
...
3. Linguistic Valuefrom a Material Viewpoint
...
that a segment oflanguage can neverin the final analysis be based
...
ingtolawsthatareunrelatedtoitssignifyingfunction. Nopositive
...
pheml '1say,'whereasthereisnopresent *stem.i;now itisprecisely
...
relative position.
In addition, itisimpossiblefor sound alone, amaterialelement,
tobelongtolanguage. Itis onlyasecondarything, substancetobe
put to use. All our conventional values have the characteristic of
notbeingconfusedwiththetangibleelementwhichsupportsthem.
...
halfitsworthofsilver. Itsvaluewillvary accordingto the amount
stamped upon it and according to its use inside or outside apoliti-
...
gauge forms its words on the basis of a system of sonorous ele-
...
forinstance, generaluseofadorsalrdoesnotprevent manyspeak-
...
3) Valuesinwritingfunction only through reciprocalopposition
...
characteristic 1). Whether I make t — he letters in white or black,
raised orengraved, with pen or chisel all this is of no importance
...
\ a difference generally implies positive terms between which theI
1 difference is set up; but in language there are only differences \
withoutpositive terms. Whetherwetakethesignifiedorthesignifier,
I
I
...
trueonlyifthesignifiedandthesignifierareconsideredseparately
...
and thissystem serves as theeffective hnk betweenthe phonic and
...
fusedifonlytheyhavesomethingin common. Orawordmayhave
...
alwayssucceedingorbeingsuccessfulon thefirsttrial. Conversely,
...
one sign from the others constitutesit. Differencemakes character
just as it makes value and the unit.
Another rather paradoxical consequence of the same principle is
this: in the last analysiswhat is commonly referred to as a "gram-
...
particularlysignificant (e.g. theformationofGermanpluralsofthe
...
with umlaut and-e) consists of theinterplay of a number of oppo-
sitionswithin thesystem. When isolated, neitherNachtnor Ndchte
isanything: thuseverythingis opposition. Puttingit anotherway,
theNacht:Ndchterelationcanbeexpressedbyanalgebraicformula
...
consistingsolelyofcomplexterms.Someofitsoppositionsaremore
significant than others; but units and grammatical facts are only
differentnamesfor designating diverse aspects of the same general
fact : thefunctioning of linguistic oppositions. This statement is so
...
onlythetwowords, thewholeseriesofsimilarwords, aandd, orall
singulars and plurals, etc.?
Units and grammatical facts would not be confused if linguistic
signswere made up ofsomethingbesides differences. But language
beingwhatit is, we shallfindnothingsimple in it regardless of our
approach; everywhere and always there is the same complex
equilibrium of terms that mutually condition each other. Putting
it another way, language is aform andnot a substance (see p. 113).
...
s'ilfait beau temps, nous sortirons 'if the weather is nice, we'll go
...
unconsciously call to mind a host ofotherwords (enseigner 'teach,'
...
moretermsthatoccurinaneffectiveseries.Againstthis, theassoci-
...
^Itisscarcelynecessarytopointoutthatthestudyofsyntagmsis nottobe
...
Theexamplesonpage 123havealreadyindicatedthatthenotion
...
whole to its parts (e.g. contre tousin opposition on the one hand to
...
It is obviousfrom the first that many expressions belong to lan-
gauge. Thesearethe patphrasesinwhichany changeisprohibited
...
true, thoughtoalesserdegree, ofexpressionslikeprendrelamouche
...
*Cf. Englishhead and waiterin headwaiter. [Tr.]
^Literally 'take the fly.' Cf. English take the bull by thehorns. [Tr.]
«Cf. English burythe hatchet. [Tr.]

---

9
SYNTAGMATIC AND ASSOCIATIVE RELATIONS 125
tete, etc.) 'have (aheadache,etc.),'aforcede {soins,etc.) 'bydintof
...
kept solely by dint of usage (cf . difficulte 'difficulty' besidefacilite
...
Indeed, since there is nothing abstract in language, the typesexist
only if language has registered a sufficient number of specimens.
When awordlike indecorable arises in speaking (see pp. 167 ff.), its
appearance supposes a fixed type, and this type is in turn possible
only through remembrance ofa sufficient number of similarwords
...
'whatdoeshesaytoyou?' etc. correspondtogeneraltypesthatare
...
vidual freedom. In a great number of instances it ishard to class a
combinationofunitsbecausebothforceshave combinedinproduc-
ing it, and they have combined in indeterminable proportions.
3. AssociativeRelations
...
;
itsgraspofthenatureoftherelationsthatbindthetermstogether,
the mind creates as many associative series as there are diverse
relations. Forinstance,inenseignement'teaching,'enseigner'teach,'
'Theanomalyofthedoublerinthefutureformsofcertainverbsin French
maybe compared to irregular plurals like oxen in English. [Tr.]

---

126 COURSE IN GENERAL LINGUISTICS
enseignons '(we) teach,' etc., one element, the radical, is common
toeveryterm;thesamewordmayoccurinadifferentseriesformed
aroundanothercommonelement, thesuffix (cf enseignement, arme-
.
meant, changement, etc.); or the association may spring from the
...
of the sound-images (e.g. enseignement andjustement 'precisely').^"
...
occur neitherin fixednumbersnor in a definite order. Ifwe associ-
...
isnotindefiniteasinthecase ofenseignement, changement, etc.; the
...
grammarian groupsthemin onewayratherthanin another;in the
...
commonrelationsconstituteslanguageandgovernsitsfunctioning.
What ismoststrikingin the organization oflanguage are syntag-
...
Thisisshownbywordformation. A unitlikepainfuldecomposes
...
statement: "Lesmusiciensproduisentlessons ['sounds,bran']etlesgrainetiers
les vendent" 'musicians produce sons and seedsmen sell them.' [Cf. Shake-
speare's"Notonthysole,butonthysoul." (Tr.)] Thisisdistinctfromthecase
...
terpretation. Folk etymologies like these (see pp. 173ff.) are ofinterestinthe
study of semantic evolution, but from the synchronic viewpoint they are in
the same category asenseigner: enseignement. [Ed.]
...
pendent. Itexistsonlythroughcombiningwithasuffix. Ingos-Ung,
the element gos-is nothingwithout its sufiix. The whole has value
only through its parts, and the parts have value by virtue of their
placeinthewhole. Thatis whythesyntagmaticrelationofthepart
tothewholeisjustasimportantastherelation ofthepartstoeach
other.
This general principle holds true for every type of syntagm
enumerated above (pp. 124 ff.), for larger units are always com-
posed of more restricted units linked bytheirreciprocalsolidarity.
...
2. Simultaneous Functioning of the Two Types ofGroupings
...
whichareinturnnecessaryforanalysisofthepartsofthesyntagm.
Take the French compound de-faire 'un-do.' ^^ We can picture it
as a horizontal ribbon that corresponds to the spoken chain:
12Cf. English misplace. To the French series correspond English mistake,
...
consciousoneormoreassociativeseriescomprisingunitsthathave
...
of syntagms, regardless oftheir class orlength, andwe bringing the
...
same process. In each series the speakerknowswhat he must vary
in order to produce the differentiation that fits the desired unit. If
he changes theidea to be expressed, he will need other oppositions
to bring out another value; for instance, he may say marchez! or
perhaps montons!
Itisnotenoughtosay, lookingatthematterpositively, thatthe
...
syntactical pattern, e.g. que te dit-il? 'what does he say to thief^
...
endowed with a value. I am thinking not only of caseslike French
...
wherethedifferencehappenstobe basedonasimplephoneme, but

---

THE MECHANISM OF LANGUAGE 131
also of the more subtle and characteristic fact that a phoneme by
itselfplaysarolein thesystem ofalanguage-state. Forexample, if
...
Some signsare absolutelyarbitrary; in otherswenote, notitscom-
plete absence, but the presence of degrees of arbitrariness the sign
:
may be relatively motivated.
For instance, bothvingt 'twenty' and dix-neuf'nineteen' are un-
...
soixante-dix 'seventy,' etc.). Taken separately, dix and neufare in
the same class as vingt, but dix-neufis an example of relative mo-
...
tree,' pommier 'apple-tree,' etc.^' Forfr^ne 'ash,' ch^ne 'oak,' etc.
...
"Cf. Englishflaxen, which suggestsflax, silken, woolen, etc. [Tr.]
" Cf. English clerk,unmotivated,against/armer, relativelymotivated. [Tr.]
...
formation the whole seriesflags, birds, books, etc., while men and
...
steso, tupso, etc.;eimi 'I shallgo,' on the otherhand, is completely
isolated.
...
Frenchcachot 'dungeon'?On comparingwordslikecoutelas 'cutlas,'
fatras 'pile,' platras 'rubbish,' canevas 'canvas,' etc., one has no
morethanthevaguefeeUngthat-asisaformativeelement charac-
teristic of substantives. At any rate, even in the most favorable
casesmotivation is never absolute. Not only are the elements of a
motivated sign themselves unmotivated (cf. dix and neuf in dix-
neuf), butthe value of the whole term isneverequal to the sum of
...
unitshave appeared asvalues, i.e. aselements ofa system, andwe
...
havegiven specialconsideration totheiropposition now we recog-
;
...
Everythingthatrelatestolanguage asasystem must, I am con-
...
Thisisthebestpossiblebasisforapproachingthestudyoflanguage
...
leadtotheworstsortofcomplicationifappliedwithoutrestriction.
But the mind contrives to introduce a principle of order and regu-
larityinto certain parts of the mass of signs, and this is the role of
...
oflanguageisbut a partialcorrection ofasystem thatisbynature
...
definition makes it impossible to conceive of a langu — age in which
everything is motivated. Between the two extre — mes a minimum
of organization and a minimum of arbitrariness we find all pos-
sible v — arieties. Diverse languages always include ele — ments of both
...
which brings out a particularform that the opposition may take
we might say thatlanguages in which there is least motivation are
...
and "grammar" and "relativemotivation" ontheother, are always
synonymous, but because they have a common principle. The two
extremesareliketwopolesbetweenwhichthewholesystemmoves,
two opposing currentswhich share the movement of language the
:
...
(structural rules).
Wewould see, forexample, that motivation plays amuchlarger
role in German than in English. But the ultra-lexicological type is
Chinesewhile Proto-Indo-European andSanskrit are specimens of
theultra^grammaticaltype.Withinagivenlanguage, allevolution-
...
proportions of the two classes of signs. Thuswith respect to Latin,
...
this shift in hundreds of instances: cf. constdre {stare): counter
...
whereitisaquestion ofacomplexandsystematicobjectgoverning
...
My
definition disagrees with the narrower one usually given.
Morphology and syntax together are what is generally called gram-
mar while lexicology, or the science of words, is excluded.
Butfirst, do these divisionsfit thefacts? Dotheyagreewiththe
principles that have just been posited?
Morphology deals with different classes ofwords (verbs, nouns,
adjectives, pronouns, etc.) and with different inflectional forms
(conjugation, declension, etc.). Toseparatethisstudyfromsyntax,
...
instance,morphologysayssimplythatthegenitiveofGreekphulax
...
anditisdifiicult, ifnotimpossible,to separatethem. Linguistically,
...
glancetolend themselvestogrammaticalstudy, whichisgenerally
...
words as by grammar. For instance, Latinfid andfacio stand in
...
Prepositionsareusuallyassignedtogrammar,buttheprepositional
...
expressedincertainlanguagesbycasesorprepositionsarerendered
...
orfinally, by simplewords (Frenchhoisdechauffage 'firewood' and
Russian drovd, French bois de construction 'timber' and Russian
Us). The interchange of simplewords and phraseswithin the same
...
state and fit thisinto a theory of syntagms and a theory of associ-
...
speakers; and syntax (i.e. the theory ofword groupings, according
...
adjective grand 'big' offers a duality offormfrom the syntagmatic
viewpoint (grd gargon written grand gargon 'big boy' and great dfa,
...
be arranged along its two natural coordinates; no other division
...
viewpoints specified in ChapterVII abstractentitiesin grammar.
:
...
thatgovern associations. Forinstance, speakersare aware that the
relation between enseigner and enseignement orjuger andjugement
is not the same as the relation between enseignement andjugement
...
valuewhichprescribesan identicalfunction. Thissuffices to create
...
mindandarethebasisforthemoregeneralnotionsofcaseand case
...
studyisdifficultbecauseweneverknowexactlywhetherornot the
...
basis, andin the endwemust always come back to theseelements.
...
fer-signum. A value may haveno relationswith a concrete element
...
creteterms. Inthesyntagmatic patterngooseberrywine, goldwatch,
...
stantive after the transitive verb (cf. je cueille unefleur 'I pick a
flower'), while Latin and some other languages use the accusative,
which is characterized by special case endings, etc.
Word order isunquestionably an abstract entity, but it owes its
...
English, the manIhaveseenapparentlyusesazero-signtostandfor
...
— —
solelyto its sounds. Conversely aswe havejust seen a meaning
andfunctionexistonlythrough thesupport ofsomematerialform.
...
asimmaterialabstractionshoveringoverthetermsofthesentence.
...
existing terms ofalanguage-state but relations between successive
...
mayvaryinrapidityandintensity, butthisdoesnot invahdatethe
principle. The stream of language flows without interruption;
whetherits courseis calm or torrentialis ofsecondaryimportance.
...
specialguarantees of preservation; thereforeit cannot showushow
much natural languages change when freed from any literary
regimentation.
— —
Phonetics and all of phonetics is the prime object of dia-
chronic linguistics. In fact, the evolution ofsoundsisincompatible
with the notion of states to compare phonemes or groups of pho-
;
nemeswithwhattheywerepreviouslymeanstosetupadiachrony.
...
GENERALITIES
141
principle that anything which is phonetic is neithersignificant nor
grammaticalin thebroadsenseofthewordphonetic (seep. 18). In
studying the history of the sounds of a word, we may ignore
meaning and, by consideringonly the materialenvelope ofa word,
...
Butsoundsarenottheonlythingsthatchangewithtime. Words
...
domain of phonetics.
Itisworthnoting, however, thatmanychangesoften considered
...
nen, Reitschule, etc. In Old High German the firstelementwas not
...
Somethingsimilaroccurred in compoundsformedwith theword
...
these changes.
Butthisrestrictiondoesnotremovealldifficulties. Theevolution
...
whichonlyapartarephonetic. Inthegenesisofasyntagmaticpat-
...
onepsychological (thesynthesisofthetwoelementsoftheconcept)
...
result from amere phonetic fact. Butforthe oppositionsto acquire
suchfunctional importance, the originalinflectional system had to
be simplified through a series of diverse processes: the disappear-
ance of multiplevarieties of the present and of the shades of mean-
...
fect, etc. These nonphonetic changes reducedverbal inflection to a
restrictedgroupofformsinwhichradicalalternationsbecamevery
...
changes, alternation, and analogical facts, and concludewithsome
...
but sounds. What is transformedis a phoneme. Thisevent, though
...
ruch became Haus, Zaun, Rauch; in the sameway ii changed toeu:
...
everyuobecame u:muotbecameMut, etc. Everyz became s (writ-
1To this didactic external reason might be added another: in his lectures
...
grammaticalinthesensethatanisolated actisnecessarilyforeign tolanguage
...
phoneticevolution:itsendresultisoutsidethesystem, forthesystemisnever
observed in its evolution; it differs from one moment to the next. This at-
tempted explanation is just asimple suggestion on our part. [Ed.]
...
not the phonologic — al species but the phoneme as it occurs under
...
Absolute changesareextremelyrare. That changes often appear
to be absolute is due to the obscure orextremely general nature of
...
based on asuperficialview ofthings. Itis more logical, in linewith
...
one or more otherphonemes. The passing of Proto-Indo-European
...
becamehinProto-Germanic (cf LatincollumandGothichals) and
.
...
Gaste.
Theresultisnot anissueineither case, andwhetherornotthere
is a changeis ofnoimportance. Forinstance, on comparingGothic
...
passing of toa. The first phoneme remained while the second one
...
sistence of P
—
roto-Indo-European i in Gothicfisks, etc. is linked to
...
(German Bruder), *li\>o (German hide), where remains. This
J?
...
Germanic, as in Latin, tended to sonorize spontaneously within
J?
aword onlytheplacingoftheaccenton theprecedingvowelcould
;
...
taneous, notcombinatory, andtheaccentisanobstacleratherthan
the precipitating cause. We should say: "Every internal became
Ip
...
—
toexplainrhotacization, forinstance (cf. Latin *genesis >generis),
...
two acts. First, s becamezthrough a combinatory change. Second,
...
—
handinmistaking themediateresultfor the immediate one (s >r
...
ThisisthesameassayingthatebecameabeforeanasalinFrench.
The fact is that there were in succession a combinatory change
—
nasaliza — tion of e by n (cf . — Latin ventum > French vent, Latin
femina » French/ewa,femd) and a spontaneous change of e to o
(cf. vant,fdmd, now vd,fdm). Toraisetheobjectionthatthe change
...
is that offormulating a phonetic lawin the present tense, as if the
facts embraced by it existed once and for all instead of being born
anddyingwithinaspan oftime. Theresultischaos, forinthisway
...
isinherentinthenatureoflanguageandfindsitdifficulttoaccount
forexceptionslike causa, rlsus, etc. Only theformula "intervocalic
...
a similarreason we must say "a became e in the Ionian dialect (cf.
...
Germanic speakers doesnot allow that" imply that amere histori-
calfactisapermanentcharacteristic. Thisissimilartothemistake
...
festations ofone and thesame tendency, butwewould findsimilar
general currents in political history and never question theirbeing
...
languages, givingthemtheirharmonioussound. Climateandliving
...
noticethatthe accumulation ofconsonantsin present-dayGerman
isinmany instances a quite recentfact, due to thefall of posttonic
...
what is said about it, isw^orth examining. It may clarify the cause
of phonetic changes or at least indicate the direction that the
search for it must take.
Thelawofleasteffortseemstoexplainacertainnumberofcases
—
...
maison 'house'), etc.
Butwe might mention just as many instanceswhere exactly the
opposite occurs. Againstmonophthongization, forexample, we can
set the change of German l, u, ii, to ei, au, eu. If the shortening of
Slavica, etod, eisduetoleasteffort, thenthereversephenomenon
—
offered by German (faster -^ Vdter, gehen » geben) must be due to
—
greatest effort. If voicing is easier than nonvoicing (cf. opera
Provencalobra), thereversemustnecessitategreatereffort, andyet
Spanish passed from z to X (cf . hixo, written hijo) and Germanic
changed b, d, gtop,t,k. Ifloss ofaspiration (cf. Proto-Indo-Euro-
—
pean *bherd > Germanic beran) is considered a lessening of effort,
whatis to be said of German, which inserts aspiration where it did
...
PHONETIC CHANGES
149
solution. In fact, we can scarcely determinewhat iseasiest or most
...
—
became ts (cf. Latincedere > Italiancedere), thereisapparentlyan
...
chain:kbecamepalatalizedk'throughassimilationtothefolloA\'ing
vowel
;
thenk' passedtoky;thepronunciationdidnotbecomemore
...
correctedinaccuracieswould win outin the individual and become
...
through a similar process thatflorem became ft'ore, thenfiore, in
Italian.
...
natural is not clear. From all appearances the choice offaulty pro-
nunciationsis completely arbitrary, and there isno obvious reason
forit. Besides, whydidthephenomenonbreakthroughatonetime
rather than another?

---

150 COURSE IN GENERAL LINGUISTICS
Thesamequestionappliestoalltheprecedingcausesofphonetic
changes if they are accepted as real. Climatic influence, racial pre-
disposition, and the tendencytowardleasteffort are all permanent
or lasting. Why do they act sporadically, sometimes on one point
of the phonologicalsystem andsometimes on another?A historical
...
nation'shistoryandinthiswaytodiscoveralinkbetween political
...
upheavals of Latinin its developmentinto the Romancelanguages
coincided with the highly disturbed period of invasions. Two dis-
tinctions will serve as guideposts:
a)
Politicalstabilitydoesnotinfluencelanguageinthesameway
...
ofa court, school, an academy, writing, etc.) which in turn is posi-
...
witheverytype ofmodification oflanguage. Grammatical changes
...
—
Still, it is impossible to cite a single period even am — ong those
...
between Proven9aland French {langued'ocandlanguedfoil) would
...
first, thishypothesis supposes circumstancesthat are rarelyfound.
...
plantation, thoughitdoesnotsolve ourproblem, hastheadvantage
...
changes of fashion.
5. The Effect ofPhonetic Changes Is Unlimited
...
derive their characterfrom the arbitrariness of the linguistic sign,^
which is distinct from the signified.
We can easily observe that the sounds of a word have been
affectedata certainmomentandsee theextentofthedamage, but
...
*aiwom (cf Latinaevom) changed to *aiwan, *aiwa, *aiw inProto-
.
Germanic;next, *aiwbecame ewin Old HighGerman, as didevery
word that containedthe clusteraiw; then the change offinal wtoo
...
Germanje (cf. das schonste, was ichje gesehen habe 'the prettiest
that I have ever seen').
The modern word does not contain a single one of its original
elementswhen considered from the viewpoint of the starting point
...
(givingeteina, ephena, etc.), where it marked the aorist. In Middle
High German the posttonic vowels i, e, a, o regularly became e
"Meaningsignifier. See p. 75, note. [Tr.]
...
accusative singularhoionandthegenitiveand dative singularhoten
merged into hoten.
...
In addition, phonetic evol \ u \ tion may break the normal relation
between two in—flected forms of the same word. In Ol—d French, for
—
instance, comes comi—iem became cuens comte, bard baronem
— \\
...
radicalchangeinthisrespect,butinGreektheverydifferenttreat-
meant of the sonant and con-sonant nasal created two distinct
seriesofiorms'.hippon, 6{w)inagainstpoda,matera.Theaccusative
...
analyzable. The word becomes an indivisible w—hole. Examples:
...
anotherway of saying that its parts can no longer be compared as
...
pletelyimpossible. TheinflectionofnounsinProto-Indo-European
is a case in point.
TheProto-Indo-Europeandeclensionwasasfollows nominative
:
...
field that state, giving dative *ek\Woi, locative *ek\Woi, nominative
...
evolutionradicallyseparatedtwotermsthatoriginallywereunited
grammatically. This phenomenon might give rise to a serious mis-
take in interpretation.
OnobservingtherelativeidentityofVulgarLatinbard:baronem
...
divergentdirectionsandproducedtwoforms?No,forthesame unit
cannot be subjected at thesame time andin thesame place to two
...
chaiseisadialectalform isforgotten. The Parisian dialect changed
...
arenotduetoexternalcauses (asinborrowings), they imply gram-
...
differentialelements {-ezo and -en- do not lend themselveswell to
...
alternation, the largest and most common of the grammaticalfacts
...
nouveau:neuf'new,' etc., where itiseasytosingleouta differential
and regularly variable element. In Latin, rhotacization causes
gero to alternate with gestus, oneriswith onus, maeorwith maestus,
etc. Since s was treated differently according to the position of the
accent in Germanic, Middle High German hasferliesen:ferloren,
...
Inalltheprecedingexamplestheradicalelementisthepart that
...
thattakesdifferentformsaccordingtothemake-upofthefirstpart
of the radical (cf. Greek apo-didomi: ap-erchomai, French inconnu
'unknowTi' : inutile 'useless'). TheProto-Indo-Europeanalternation
e: 0, which certainly must, in the last analysis, have a phonetic
basis,isfoundinagreatnumberofsuffixalelements (Greekhippos:
...
two definite soundsorgroupsofsoundsandshiftingregularlybetween
two series of coexistingforms.
...
neuveandnouveau) throughaphonetic changeisfabricatingan im-
...
netic simplybecause soundsmakeupitssubstance and playapart
initsgenesisthroughtheiralterations. Thefactisthatalternation,
whether considered from its starting point or end result, is always
both grammatical and synchronic.
5. Laws ofAlternation
...
discriminately (geben: gibt, Field: Gefilde, Wetter: wittern, helfen:
...
seethatthealternationcoincideswithdistinctionsoftense, person,
...
under ablaut (consider alsofinden:fand, orfinden: Fund, binden:
...
result oftheunderlyingphoneticfacts. When phoneticfactscreate
...
that the a ofNacht changes to a in the pluralNachte, forthis gives
...
lawthusseemsto applylikea rulethatgovernsusagetotheextent
of modifying it. Butwe recall that in language these permutations
...
In Old High German, forinstance, thepairs cited on page 158 had
the forms gehan: gibit, field: gcfildi, etc. During that period the
...
to a phonic condition which speakerswould have expressed in this
way the a of such words asfacto and amicus alternates with i in
:
...
above (see pp. 96 ff.). Faced with apairlikefacid:conficio, wemust
...
temptedto confusethemsince the cause ofphonetic differentiation
...
Allofthisconfirmswhatwassaidaboutthestrictlygrammatical
nature of alternation. Theword permutation, whichis apt in some
...
Itisobviousfromthefirstthatanyslightlyregularphonicoppo-
...
customedto seeinge alternatewith i. As soon asspeakersfeel that
...
r-before avowel (rouvrir 'reopen,' racheter 'buy back,' etc.). Simi-
...
changes win out over the formsgrouped under general patterns; in
...
logicalform is aform made on the model of one or more otherforms
...
This dualitywaseliminated by thenew form honor, created on the
...
Foralongtime French speakerssaidilpreuve, nousprouvons, its
...
prove/ usingforms that have no phonetic explanation. II aime 'he
loves' isderivedfrom Latin amatwhilenousaimons 'welove' isthe
analogical form foramons; speakers should alsosayamahle instead
of aimable 'amiable.' In Greek, intervocalic s disappeared: -oso-
became-eo- (cf
.
geneosfor*genesos)
.
Still,intervocalicsisfound in
...
a:pephugmai, pephugmetha, etc., andthelanguageofHomershows
thatthe awasformerlymissingin the pluralandin the dual of the
...
tionalelement, totheradical,formingpepheuga-men. Thereverse
—
attaching the radicalelement to the suffix is muchmore common
(see p. 170).
...
present hahem, lohom, etc. The-mderivesfrom afewverbs similar
:
to-^miverbsinGreek (bim, *tdm, gom, tuom), which by themselves
forced the ending on thewhole weak conjugation. Notice that here
...
Everyhbertytakenwithrespecttothisstatewasthenananomaly.
The neogrammarian school was the first to assign analogy to its
properplacebyshowingthatitis, alongwithphonetic changes, the
...
that honoris amodification, a "metaplasm," of honos and say that
...
and disappears. The result iswhat gives the impression of a trans-
...
fromtheevolutionofsounds. Atthemomentwhen honorwasborn,
...
formbyanotherthatitoftenproducesformswhichreplacenothing
...
=
X repressionnaire
Inneithercaseistheretheslightestpretextforspeakingofchange
repressionnaire replaces nothing. Another example: some French
speakers use the analogical formfinaux instead offinals, which is
more common; someone might coin the &dieciivefirmamental and
give it the plural formfirmamentaux. Should we say that there is
change infinaux and creation infirmamentaux? Inboth casesthere
iscreation. Onthepatternofmur 'wall'
:
enmurer 'wallin,' speakers
...
Inotice thatentorner and ajorner, built on torn andjorn, wereused
...
principle oflinguistic creativity in general. What is that principle?
...
Analogy is gram — matical t — hroughout, but let us hasten to add
...
the first, andit points to the essence of the linguistic mechanism as
...
gaged in decomposingitsunits, and this activity contains not only
every possibility of effective talk, but every possibility of ana-
logical formation. It iswrong to suppose that the productive proc-
...
keeper' wasnotengendered bymagasin. Itwasformed on the pat-
...
maticaldoctrines. Europeangrammarsworkwithproportion they
;
...
fromanalysiswouldbegiven, andfromtheseelementswholewords
...
obvious proof : quantity is not the same infactus and actus despite
...
guages.Theoppositionspecio:spectusagainsttego:tectusisreflected
...
werenotinheritedfromProto-Indo-European, whichcertainlyhad
...
theradicalunitsag-, teg-,reg-.The feehngforword-parts (radicals,
...
Nothingenterslanguagewithouthavingbeentestedinspeaking,
andeveryevolutionaryphenomenonhasitsrootsin theindividual.
...
a rival strongenough to replace honos, one speakerhad to coin the
...
mort 'dead,' etc. But adultsuse them too. For instance, many peo-
...
newformationbecomesdefinitelyinstalled andeliminatesitsrival,
something is actually created and something else abandoned, with
theresultthatanalogyoccupiesapreponderantplaceinthetheory
of evolution.
This is the point that I should like to emphasize.
2. AnalogicalInnovations as Symptoms ofChangesinInterpretation
...
to the next? The cause of change mustbe sought in the great mass
...
becauseitresultsfrom asetof comparisons, depends constantlyon
theassociativeenvironmentoftheterm. TheProto-Indo-European
superlative *swdd-is-to-s contained two independent suffixes, -is-,
whichcarriedtheideaofcomparativedegree (cf. Latinmag-is) and
-to~, whichdesignatedthe definiteplaceofanobjectin aseries (cf,
...
in favor of the formativeelement, especiallywhen the former ends
...
analysisver-itdt-em;inthesamewayRomd-nus, Albd-nus (cf. aenus
for *aesno-s) became Rom-dnus, etc.
Changes in interpretation, no matter how they start, always
becomeapparentthroughtheexistenceofanalogicalforms. Indeed,
iflivingunitsperceivedbyspeakersataparticularmomentcanby
...
Analogy is therefore proofpositive that aformative element exists
...
A particularlyunusualexamplewillshowhowanalogyworksout
...
substituting ofmoreregular forms composed of livingelementsfor
older irregular and obsolescent forms.
Doubtlessthingsdonotalwaysrunsosmoothly.Thefunctioning
oflanguage isdisturbedbymanyhesitations, approximations, and
semianalyses. At no time does an idiom have a perfectly stable
system ofunits. Fromwhatwassaid about the inflection of *ekwos
against *pods, itis obvious that imperfect analysessometimes lead
...
But analogyinfluences language evenwhen there is groping and
...
turiesofevolution, almostallelementsarepreserved;theyareonly
...
changefrom themotherlanguage to Modern Frenchwould occupy
lessthan the space ofone page (e.g. est 'is' = *esti, numbers, words
likeours 'bear,' nez 'nose,' pere 'father,' chien 'dog,' etc.). The vast
majority ofwords are, in oneway or another, new combinations of
phonic elements torn from older forms. In this sense analogy, for
theveryreasonthatit alwaysuses oldmaterialforitsinnovations,
...
Thestabilityofaguntisjustasmuch theworkofanalogy asisany
...
siderwhatishappeningtoFrenchdites '(you) say' andfaites '(you)

---

FOLK ETYMOLOGY
173
do,' which are direct descendants of Latin dic-itis andfac-itis. Be-
...
plaisez 'please,' lisez 'read,' etc.) areheard today, and the new end-
ings are already common in most compounds {contredisez 'contra-
dict,' etc.).
The only formsleft untouched by analogy are of course isolated
...
Chapter VI
FOLK ETYMOLOGY
Wesometimesmanglewordsthathaveunfamiliarformsandmean-
...
and thenounpointe 'point.'* Suchinnovations, nomatterhowodd
...
this becameshame-fast, then shame-faced. [Tr.]

---

174 COURSE IN GENERAL LINGUISTICS
hardlybedistinguishedfrom analogy. When aspeakerforgetsthat
French surdite 'deafness' exists and coins analogical sourdite,^ the
resultis the same asifhe had misunderstood surdiie and deformed
...
only in absurdities.
But this difference, which concerns onlythe results, isnotbasic.
Theirbasic dissimilarity goesmuch deeper. In order to seewhat it
...
soundly'goesbacketymologicallytohliuwan'flog'butisassociated
...
suggestthatachangeofformresultedfromthenewinterpretation,
but the change actually relatestothe influence ofthewritten form
...
piece of coal' became Karfunkel (through association withfunkeln
...
'chink' in French under the influence oifeutre 'felt.'^ Whatstrikes
...
parts (Kar-, escar-, cat-). We might saythat they areparts offolk
etymologies thatstopped atthehalf-waypoint. Karfunkelisinthe
same classasAhenteuer (if-teuerisconsidered anunexplainedresi-
...
it.
The two phenomenahave only one common characteristic peo-
:
...
p. 168). The olderformmustevenbeforgotten beforetherival can
appear. Analogytakesnothingfromthesubstanceofthesignsthat
itreplaces. Againstthis, folketymologyissimply aninterpretation
oftheolderform remembranceoftheolderform,thoughmuddled,
;
*Cf. Englishcrayfish, derived from Old Frenchcrevice, fTr.]

---

176 COURSE IN GENERAL LINGUISTICS
is the starting point of the deformation that it underwent. The
basisfor analysisis remembrance in oneinstance and forgetfulness
...
tenceintooneunitwhichisabsolute orhardtoanalyze. Suchisthe
...
twowords, then ceci 'this' anew wordwas the result even though
:
its substance and constituents did not change. Compare also:
French tousjours 'every day,' toujours 'always,' aujour d'hui 'on
today's day,' aujoiird'hui 'today,' desjd 'since now,' dejd 'already,'
vertjus 'green juice,' verjus 'verjuice, sour grapes.' Agglutination
may alsoweld together the subunits of aword, aswe saw (p. 170)
...
cepttothewhole clusterofsigns, whichthenbecome asimpleunit.
3) Everyother changenecessarytomake the old clusterofsigns
—
...
just, tousjours, etc. becamesimplewordsbecausetheyweregrasped
as a single idea.
...
twosubunitsbecome one (cf. hed-isto-sfrom *swad-is-to-s) . Against
this, analogy starts from lesser units and builds them into greater
units. To createpdg-dnus, analogy united the radical pdg- and the
suffix -anus.
...
alreadysaid that itis a simple mechanical process in whichmerger
...
slowlyset, i.e. aresjmthesizedto such an extentthat their original
...
gauge. Only analogical creations may be named compounds or
derivatives.'^
...
forms*es-mi, *es-ti, *ed-mi, etc. Weretheelementses-, ed-, etc. real
...
'Thisamountsto sayingthatthetwophenomenaactjointlyin thehistory
...
dromo-s, etc. in Greek started through partialagglutination at aperiod when
...
cameaproductivemeansofformingnewcompoundsbeforecompletewelding
...
oftheinfinitive withthepresenttenseoftheverb habere (facerehabed 'I have
...
elementstothepointwheretheelementsbecomecompleteunitsandproduces
—
only unanalyzable or unproductive words (e.g. hanc horam > French encore
'still'), i.e. itislexicological. [Ed.]
...
tion is lacking, it ishard to determine what is due toagglutination
and what results from analogy.
Chapter VIII
DIACHRONIC UNITS, IDENTITIES AND
REALITIES
StaticUnguisticsworkswithunits that owe their existenceto their
sjmchronicarrangement. Everythingthathasjustbeensaidproves
that in a diachronic succession the elements arenot delimited once
...
gauge, with the result that they would be more aptly represented
by the drawing:
Period A
^ Period B
Thisis confirmed by all that has been said about the consequences
...
and modify the action of the verb. For instance, therewasnothing
...
wasunitedwith the substantive oreos, andthewholewasjoinedto
hainotoserveasitscomplement. (2) Anewverbalclass (katahaino)
...
In allthreeinstances, therewasthenanewdistributionofunits.
...
phenomenonwithouttheunitingofacertainchainofconceptswith
...
by no means a complete report of what hashappened in language.
...
unit cannot be the same inboth cases. In any event, we cannot ac-
curately define the unit until we have studied it from both view-
points, the staticandtheevolutionary. Untilwe solvetheproblem
...
chan — ged its form ormeaningwhi — le continuing to exist as a distinct
unit forbothpossibilitiesexist Imustknowthebasisforstating
...
'wean' andsepardre. Fleurir'flower,' however, isnotthesamething
...
sibleforsoundalonetoaccountforidentity. Doubtlessitiscorrect
tosaythatLatinmareshouldappearinFrenchasmer 'sea'because
...
Onespeakermaysaysefacher 'becomeangry'whilesomeonewho
lives in another part of France says sefocher, but this difference is
...
identitiesin speakingwithout therebeing abreakin their common
...
peatedseveral timesduringalectureisjust asinterestingasknow-
...
gauge is subjective analysis. One must guard against confusing
...
;
thoughtof-bdsasaninflectionalwholeinoppositiontotheradical.
...
languagearewrong;thetruthisthatsubjectiveanalysisisnomore
...
—
althoughbothuse thesameprocedure the confrontation of series
...
gauge.
Historical analysis isbut a modified form of subjective analysis.
Basically, it consists of projecting the constructions of different
periodson asingleplane. Itresemblesspontaneousanalysisinthat
it tries to identify the subunits of words but differs in that it syn-
thesizes all the divisions made in the course of timewith a view to
...
severaltimes. Objective analysis addsup and schematizes the suc-
183
...
thesedistinctions. Onewouldthink, toreadBopp andhisdisciples,
...
while speaking, e.g. that paterwas to them the root pa + the suffix
-ter, that doso stood for the sum of do + so + a personal end-
ing, etc.
There had to be a reaction against the aberrations of the old
school, andtheappropriatesloganwasthis Observewhathappens
:
...
toanalyseslikethosemadebyBopp, theneogrammarians, faithful
...
position. But unless there is some justification for settingup these
categories, why bother? And if they are set up, by what authority
can one division like hipp-o-s, forinstance, be declared better than
another like hipp-os?
The new school, after pointing out the shortcomings of the
— —
old doctrine and thiswaseasy was satisfied to reject thetheory
but remain fetteredin practiceto a scientific apparatusthatitwas
...
meaningto the expedients of the grammarian. Thatiswhat I have
tried to do above by showing that objective analysis, which is

---

APPENDICES TO PARTS THREE AND FOUR 185
intimatelylinked to subjective analysis of thelivinglanguage, has
a definite and rightful place in linguistic methodology.
2. Subjective Analysis and the Defining ofSubunits
...
First, the inflectional ending, i.e. theword-finalvariable element
that distinguishes the different forms of a noun or verb paradigm.
Inzeugnu-mi, zeugnu-s, zeugnu-si, zeugnu-men, etc. 'I harness,' etc.,
...
emerges spontaneouslywhen we compare a series of relatedwords,
...
Zeugnu-, separated above from zeugnu-mi, zeugnu-s, etc., isafirst-
...
110 f.) concerningthe defining of the word-unit. [FA.]
...
radical. Butzeug-isirreducible. To carryitsdecomposition further
by comparing related forms is not possible.
The root is the irreducible element common to all words of the
samefamily. But anysubjectiveand synchronic analysisseparates
...
highestdegree of abstraction andgenerality. Naturally, indefinite-
nessvariesfromoneroottothenext, butit alsodependssomewhat
ontheextenttowhichtheradicalisreducible.Themoretheradical
isshortened,thegreaterthelikehhoodthatitsmeaningwillbecome
abstract. Thus zeugmdtion suggests a little team, zeugma any team
whatsoever, andzeug-theindefinitenotionofyokingorharnessing.
...
point, and thisiscontrarytothegeneralandabstractnatureofthe
root. But what about the numerous roots and inflectional themes
that apparently mingle? Take Greek phloks, genitive phlogos
against the root phleg-: phlog-which isfoundin everyword of the
...
meaningorriskconsideringthematerialform onlytotheexclusion
...
inflectionalendingofzero. Inthesameway, phlog-isathemewith
...
uniform;almostalwaysmonosyllabic (cf. streit-, hind-, haft-,etc.),
...
radical (e.g. zeug-mat-) ortoafirst-graderadical tomake asecond-
...
whole. Thisisduetotheverynatureoftheprefix. Acompleteword
usuallyremainsaftertheprefixisremoved (cf. Frenchrecommencer
...
morestriking examples. Moreover, manyprefixesfunction as inde-
pendent words: cf. French centre 'against,' mal 'ill,' avant 'before,'
sur 'on,' German under, vor, etc., and Greek katd, pro, etc. But the
...
Theresultis thatthefirstpart oftheradicalisusually delimited
beforehand. The speaker knows, before he has made any com-
parisonswith otherforms, whereto draw the linebetween thepre-
...
thathavethesameradicalorsuffix, andtheresultingdelimitations
...
word, providedthat possibleoppositionsexist. In Latin diddtorem,
...
3. Etymology
Etymologyisneitheradistinctdisciplinenor adivisionofevolu-
...
meanstorelatetoknownterms, andinlinguistics, toexplainaword
...
facts. But this description isnot methodical, for it followsno fixed
...
—
diversity linguisticdifferencesthatappearwhenwepassfromone
countrytoanotherorevenfromoneregiontoanother. Divergences
...
aware of its idiom.
We notein passingthatthisfeelingmakes primitivepeople look
uponlanguageasahabitorcustomlikedressorweapons. Theterm
...
leadingwhen onegoes sofar as to seelanguageasan attribute, not
of the nation, but of race, in the sameway as the color of the skin
or the shape of the head.
It is also worth noting that each nation believes in the su-
periority ofits own idiom and is quick to regard theman who uses
a different language as incapable of speaking. For instance, Greek
hdrbaros apparentlymeant 'onewhostammers' and was related to
...
concernedonlywiththediversityofthedifferentHellenicdialects,
butthiswas becausetheirinterest didnotgenerally gobeyond the
...
Agroupofrelatedlanguagesmakesupafamily. Modernlinguistics
...
TherehavebeenattemptstofindsimilaritiesbetweenFinno-Ugric^
and Indo-European, between thelatter andSemitic, etc., but such
comparisons always come up against insuperable barriers. One
mustnot confusewhatis probablewithwhatisdemonstrable. The
unive — rsal kinship of languages is not probable, bu — t even if it were
...
diversity differencesbetweenlanguagesthathavenorecognizable
or demonstrable kinship. What method should linguistics use in
each ofthese degrees? Letus begin with the second, which ismore
common. Aswehavejustnoted, countlesslanguagesandfamiliesof
^Bantu is a groupoflanguages spoken by SouthAfrican tribes, mainlythe
Kaffirs. [Ed.] — —
...
originalidiom.ThefamilyisapartofthegreatUral-Altaicgroupoflanguages,
which have no proven common origin although some traits appear in all of
them. [Ed.]
'See hisL'unitd,d'originedel linguaggio, Bologna, 1905. [Ed.]

---

COMPLICATIONS OF GEOGRAPHICAL DIVERSITY 193
languages are not related. A good example is Chinese with respect
to the Indo-Europeanlanguages. Thefactthattheydifferdoesnot
mean thatthey cannotbe compared, for comparison is always pos-
...
includesdiachronicfacts, the phonetic evolution of two languages,
...
determinethemake-upofanylanguage reciprocally, thediscovery
;
oftheseconstantdataisalwaysthemain aim of anycomparison of
related languages.
—
The other class of differences those thatexist withinfamilies of
—
languages offers an unlimited field for comparison. Two idioms
may differin any degree. Theymaybear a striking resemblanceto
...
wordmustbeusedloosely. We shallseethatlanguagesanddialects
...
Up to thispoint geographical diversity has been presented in its
...
butincludedwithintheboundariesofthesamestate, asinSwitzer-
...
intermingledandstillkepttheiridiomsdistinct. Torealizethisfact
...
coexisted for a rather longtime, and Russian has been added more
recently. In Courland and Livonia, Lettish, German and Russian
are spoken; German, which was brought in by colonists under the
auspices of the Hanseatic League during the MiddleAges, belongs
...
—
imaginablelanguageisfound Turkish,Bulgarian,Serbian, Greek,
—
...
maybeacertain relativeterritorialdistribution. Oftwolanguages,
one maybe spoken in town and the other in the country, but such
a distribution is not always clear-cut.
Thestorywas the samein ancienttimes. A linguisticmap of the
...
dominant languagebefore the arrivalofthe Romans. In Carthage,
...
tohappenwheneveranationreachesacertainstageofcivilization.
ByliterarylanguageImeannotonlythelanguageofliteraturebut
...
tage overthe others, andforthisreasonit habitually splinters. But
...
privileged dialect, afterithasbeen promoted totherank of official
and standard language, seldom remains the same as it was before.
Itacquiresdialectalelementsfrom otherregionsandbecomesmore
...
ableinliteraryFrenchandtheToscaninStandard Italian. Butthe
...
parts of France, likeSavoy, where French is an imported language
...
languages.
Ithasbeen thesamewith allnations thathavereacheda certain
stageofcivihzation. TheGreekshadtheirkoine, derivedfromAttic
...
mightpassasnormalforcesinthehistoryoflanguages. Buttokeep
...
GermanicsinceitisintheFlemish part ofBelgium
;
thoughFrench
isspokenthere,whatmattersistheboundarybetweentheFlemish
andWalloonterritories. Li^geis Romanceforthesamereason
:
itis
...
BrestbelongslinguisticallytoBreton theFrench spokentherehas
;
...
:
CAUSES OF GEOGRAPHICAL DIVERSITY 197
Chapter III
...
—
happen if a l — anguage spoken at one clearly delimited point e.g. a
...
andthelikewouldseparatethelanguageofthesource (S) from the
...
time. Takealinguisticfeatureathatcan bereplacedby h, c,d, etc.
...
phenomenon but does not expl — ain it. Undoubtedly divergence in
spacewasanecessarycondition nomatterhow smallthe amount
—
...
Oneobjectionmightbethatdifferencesinenvironment, climate,
...
Suchinfluencesareopentodispute, however (see p. 147 f.). Even if
...
Thatquestion we cannot answer. Butchange itself (leaving out — the
special direction it takes and its particular manifestations) in

---

: :
CAUSES OF GEOGRAPHICAL DIVERSITY 199
—
...
will varyfrom zoneto zone no records indicate that any language
;
has ever changed in the sameway throughout its territory. There-
fore, it is not the diagram
but the diagram
that gives the true picture.
How do differencesthat result in themostvarieddialectalforms
...
vationsthatincludeasmany partialfacts as couldbe enumerated,
described, andclassifiedaccordingtotheirnature (phonetic,lexico-
...
ritory, eachdialectalfacthavingitsspecialzone (themorecommon
...
zones; nothingpoints to which way theywill spread; all we can do
...
beforeatoth, dz, then h, z (cf. cantum—^chant 'song,' virga — » verge
...
'cat,' rescape forrechappe, which wasrecently adoptedby French,*
...
of two of its extremes probably vnW not be able tounderstand each
...
neighboringlocalities, but there isnothing to showexactlyhow far
eachpeculiaritywill reach. Forinstance, in Douvaine, alocality in
...
Douvaine, speakers saydaue fordeux 'two,' butthispronunciation
...
and covering distinct zonesplaced sideby side on a map (a, b, c, d,
etc.). Butnaturaldialectaltransformationsproduceentirelydiffer-
ent results. Assoon aswestudied each phenomenon separately and
...
r-M' ^ V--H
Thenotion ofnaturaldialects is therefore incompatiblewith the
notion offixed well-defined zones. This leaves us with two choices:
...
peculiaritieswillnotextendbeyondthispoint ; or (2) wemaydefine
...
many should also be mentioned.^ Theform of the atlasis predeter-
mined, forwehavetostudya countryregionbyregion, andamap
...
bringtolightthephonetic,lexicological,morphological, etc. peculi-
...
Linguisticatlasesareusefulinthattheyfurnishmaterialforworks
...
beingpartial, may characterize thewholeperimeteroftwoormore
zones:
A
VA
>.*x t'J
A dialectisdefined, roughly speaking, by asufficient accumulation
...
which veil, without ever erasing completely, thebasic and natural
fact of differentiation from zone to zone.
4. Languages Have No Natural Boundaries
Preciselyhow alanguagediffersfrom adialectishardtospecify.
Often a dialect is called a language because it has produced a
Uterature. Thisistrueof Portugueseand Dutch. Intelligibilityalso
plays a part; everyonewould agree that people who do not under-
...
guages. Thesize of the territorymakes no difference. Wewould be
...
nates, here Italian," butin theintermediateregions thedistinction
would disappear. We might imagine a compact, more restricted
—
zone of transitionb — etween twolanguages e.g. Frovengal between
...
betweendialects, arehiddenintransitions.Justasdialectsareonly
...
mon, due tocircumstancesthat have destroyedimperceptibletran-
...
both Iranian and Germanic, andthisconformswith thegeographi-
...
couldreadilyassigneachidiomtoitsproperplace.Andyet, assoon
...
SlavsnortheGermanswerestationary;theyemigrated, conquered
...
were oncein contact. If the Italianswholivein Calabriasettled on
the French border, the move would naturally destroy the im-
perceptible transition between Italian and French. A number of
similarfactsaccountsforthedistributionofProto-Indo-European.
Stillotherforceshelptowipeouttransitions. Takethespreading
of standardlanguages at the expense of patois (see pp. 195 ff.). To-
...
Thelaws thatgovernthe spread oflinguisticphenomena are the
...
*In his lectures Saussure used the English wordintercourse. [Tr.]
...
into a village, displaces a part of the populationwhenever there is
a festival or fair, unitesmen from different provinces in the army,
etc. Inaword, itisaunif3angforcethatcounteractsthesplintering
...
secondform thatintercoursemaytakejustifiestheuseoftheword
...
continentalGermany, firstspread overthesouth, between 800 and
850 A.D., exceptfor Franconiawhere ]) persisted as soft 6 and did
...
eighth-centuryThuringiancharter. DuringalaterperiodGermanic
...
sound tended to radiatefrom its source, and ts became the rival of
the original t or of other sounds that might have evolved from it
atotherpoints. Atitssourcesuchaninnovationispurelyphonetic,
...
andspace.Take
ts,
whichcamefromanoutsidesourceandreplaced
t.
Thisisanexample,notofmodificationofatraditionalprototype,
but ofimitation of a neighboring dialect, irrespective of the proto-
...
averysmallareacomparabletoapoint (seep. 202), e.g. avillage
...
ononlyoneforce, neveronboth;everyfeaturesharedwithanother
dialect isdue tointercourse
;
everyfeature that belongsexclusively
...
of A (A\ A^, A^, etc.). Onlargerareasthetwoforcesthereforework
...
by defending it againstoutside competitors. We cannotforeseethe
final results of the action of the two forces. In Germanic territory,
which reached from theAlps to the North Sea, the change from
]>
...
differencebetweenthissecondphenomenonandthefirst. Thesame
forces are present; only the intensity of their action varies.
Practically, this means that in studying linguistic evolutionswe
can disregard the individualistic force. That is, we can consider it
asthenegative side oftheunifyingforce. Thelatter maybestrong
enough to unify the whole area. If not, the phenomenon will come
toastandstillaftercoveringonlyapartoftheterritory. Internally,
...
withoutbringing in provincialism, which is nothing more than the
...
therebeganatwofoldevolution. OntheonehandweretheGerman
...
conquest; it may also resultfrom isolation. Rumanian lost contact
...
— —
limitedpoints twosmallislands, inourexample wherewemight
disregard a gradual spread. Now, however, with two territories
that cover a broader area, wefind once morethat agradual spread
...
had diverged enormously, theyfailed to realize that the differences
...
tribes, torn awayfrom the originalstockbymigration, had carried
...
forenot only gives a truer picture of Proto-Indo-European ; it also
reveals the causes of differentiation and the conditions that de-
determine the kinship of languages.
...
specialeffects. Buttheseeffectsminglewiththoseofdifferentiation
wherecontactismaintained, and the difficultyofidentifyingthem
bringsusback to theproblem of the evolution of an idiom in sepa-
rate territories.
Take Old EngUsh. It broke away from the Germanic trunk as a
result ofmigration. In all probabihtyit would not have itspresent
form if the Saxons had stayed on the continent during the fifth
century. Butwhatwere the specific effects of separation? Itwould
...
We
to spread throughoutourimaginaryEnglish colonyinJutland.
...
immediatelyopensthedoortopotentialseveranceofeveryrelation
...
heritageanumberoftraitsthatattesttheirkinship, butsinceeach
language will evolve independently, new characteristics that
appear in onewill not befound in the other (with theexception of
...
theotherterritory. Theyactuallyform adistinctbranch, detached
from the trunk.
...
p. 90).
Theprospectivemethod, which correspondsto the actual course
...
covering several successive centuries, are constantly aware ofwide
...
basedentirelyon textual criticism, buttheretrospectiveviewpomt
...
—
rate i — nductions will be, and the results if sufficient data are at
...
whichwecan compareit. Butby comparingagroup ofrelatedlan-
...
—
these differentidioms onlyindirectly, through the reconstructive
...
sibletodrawtheprospectiveoutlineofLatin,whosehistoryhardly
begins before the third or fourth century B.C., only after the re-
construction of Proto-Indo-European had given an inkling ofwhat
...
describestablestates (e.g. thepresentstateofLakeGenevaBasin)
without considering what might have preceded in time, but its
main concern isthe chain ofeventsandtransformations thatmake
up diachronics. A prospectivegeologyis conceivable, but in reality
the viewpoint is usually only retrospective. Before recounting
whathasoccurredatagiven pointon theearth, thegeologist must
...
soundistheterminalpoint ofseveral originallydistinctphonemes
= =
cf. ter (terre 'earth') terram, verz (verge 'rod') virgam, fe (fait
= We
'fact') factum, etc. could present the evolution of formative
elementsintwoways, and thetwo pictureswould bejust as differ-
ent; everything that was said about analogical formations (see
pp. 169 ff.) isa priori proof. Thusthe (retrospective) searchfor the
originofthesuffixofFrenchparticiplesin-etakesusbacktoLatin
-dtum; the Latin suffix is related etymologically to denominative
Latinverbsin-are, whichgo backmainly tofemininesubstantives
...
Latinin-clu-tu-s, Sanskritgru-ta-s, etc.) finally, -dtumincludesthe
;
...
participle (aime 'loved' = amdtum, Jini 'ended' = finltum, close
...
thingelse entirely. The glaringmistake of the earliest scholars had
varied and far-reaching consequences. Doubtless their hypothesis
wasnotstatedso categorically as Ihaveimplied, butitwastacitly
accepted in practice. Bopp wrote that he "did not think that
Sanskritcouldbethecommonsource," asiftherewereapossibility
...
manityisnottrueofspeech
;
theabsolutecontinuityofitsdevelop-
meant prevents us from distinguishing generations in it. Gaston
...
olderthan thePersian ofFirdausi. In aspecificcaseUkethis,where
...
1540, is nolessvaluablethan OldSlavic, whichwasrecordedin the
...
Buttheearliestlinguists, becauseoftheirconfusednotionofage,
...
that theevidencewhichthislanguagefurnishesisworthmorethan
...
representativeofthewholegroup anddidnot trytobecomebetter
...
thesource of the otherdialects. As regardsSlavic, theybased their
...
havebeen setdowninwritingatsuccessivedatesrepresentexactly
...
scriptionsofDariusisthesamedialectasthePersian oftheMiddle
...
etc. None of these dialects or groups ofdialects is the continuation
...
vertical, thefirst known dialect (A) would contain everything that
we could deduce by analyzing successive states. But by searching
for the point of convergence of allthe dialects (A, B, C, D, etc.) in
...
peatedlyemphasized this point (see pp. 3 ff. and p. 198 f.). Thus
we explain Latin medius against Greek mesos, without going back
toProto-Indo-European, by positing an olderform *methyos asthe
sourceofbothmedius andmesos. Orwemaycomparetwoformsof
...
We notein passingthat comparisonshaving to dowith phonetic
changesmustalwaysrelyheavilyonmorphological considerations.
In examining Latin patior and passus, I bring infactus, dictus, etc.
becausepassusis aformation of the same class. Bybasingmy con-
...
alwaysresultinaconjecturewhichwecanexpressbysomeformula
...
servation that Latin / infumus stands for Proto-Itahc ]), or that
the initial element of Greek alio and Latin aliud already existed as
ain Proto-Indo-European)? Reconstructionmaywell confineitself
to the second type of research; its analytical method has no aim
otherthanthesepartialobservations.Still,fromthesumofisolated
facts, we can draw general conclusions. A series of facts similar to
those pertainmg tofumus allows us to state with certainty that
\>
...
We can go even further. It is possible, afterwe have reconstructed
the different facts, to synthesize those relating to the whole form
andtoreconstructwholewords (e.g. Proto-Indo-European *alyod),
...
formisnot asolidarywhole. Itisasumthatwe canalwaysanalyze
phonetically. Each of its parts is revocable and subject to further
examination. Therefore, restoredformshavealwaysbeen afaithful
reflection ofthegeneralconclusionsapplicabletothem. TheProto-
Indo-Europeanwordfor 'horse' wassuccessivelyposited as *akvas,
*akivas, *ekivos, and finally *ekiWos; only a and the number of
phonemes have remained undisputed.
The ai — m of reconstruction is, then, not to restore a for — m for its
own sake this would be rather ridiculous to say theleast but to
...
foranoverallviewofthelanguagestudiedandofitslinguistictype.
...
Thewhole setofreconstructionsimmediatelyilluminatesthebroad
...
therulesgoverning one and thesameoriginalalternation e-o-zero.
:
...
2. Relative Accuracy ofReconstructions
We are absolutely certain of some reconstructed forms, but
othersareeitheropentodisputeorfranklyproblematical. Wehave
just seen that the accuracy ofwhole forms depends on the relative
...
sounds, but to give weight to t — hem is antilinguistic ; t — he average
eardoesnotsinglethemout, and evenmoreimportant speakers

---

RECONSTRUCTIONS
221
alwaysagreeonthenumberofelementsinsuchasequence. We can
...
mentsoftheProto-Indo-European system appearinnofewerthan
— —
a dozen forms and the most frequent in a thousand all attested
through reconstruction. Withthiswearesure ofknowingthem all.
...
lute quality of e in *ekiwds or for puzzling over whethere was open
...
singled outbylanguage (a, o, e, etc.). Thisisanotherwayofsaying
thatthefirst phoneme of *ekiw6sdoesnotdifferfrom the second of
...
phonemestakenfromthephonologicalgamutoftheoriginalidiom.
...
gauge implies consanguinity, that a family of languages matches
an anthropological family. The facts are not so simple. There is,
forinstance, aGermanicracewith distinctanthropological charac-
teristics: blond hair, elongated cranium, high stature, etc.; the
Scandinavian is itsmost perfect example. Still, not all populations
...
navian. Mightwe at least assume, however, that an idiom belongs
exclusivelytoonerace, and thatifnationsbelongingtootherraces
...
submittothelanguageoftheir conquerors (e.g. theGaulsafterthe
...
stanceswhereanthropological andlinguistic evidencedonot agree,
itisnotnecessary to setthe two types ofevidencein opposition or
...
—
linguistic community. Butthereisanothertypeofunity theonly
—
...
zation, common defense, etc., which springup even among nations
...
on the commonidiom; conversely, linguistic communityisto some
extentresponsibleforethnicunity. In general, ethnicunity always
...
mitted more orless directly through social filiation to every nation
...
Hisworkhasserved asamodelformanyothers;itisstillthemost
...
whichheplacesinBactriana, andstudiesthefloraandfaunaofthe
...
paleontology.
Other effortsin thesamedirectionhavesincebeenmade. Oneof
themorerecentis HermannHirt'sDieIndogermanen (1905-1907).^
Basing his research on the theory of J. Schmidt (see p. 209), Hirt
triestoidentifythecountryinhabitedbythe Indo-Europeans. But
...
theminsouthernRussia,whichisbettersuitedtonomadiclife. The
...
andtheVistula, morespecificallyintheregionof Brandenburgand
Berlin. We should also recall that even before Pictet, Adalbert
1 Cf. alsod'Arbois deJubainville, Les premiers habitantsdeVEurope (1877);
O. Schrader, Sprachvergleichung und Urgeschichie and Reallexicon der indoger-
manischenAIterturnskunde(worksthatappearedalittleearlierthanthe volume
...
Kuhnand othershadused linguisticstoreconstructthemythology
...
realizedhow rare arewordswithwell-established origins, andhave
becomemorecautious. Hereisanexampleoftherashnessthatonce
prevailed. Given servus and servare, scholars compared the two
—
theyprobablyhadnorighttodothis andbygivingthefirstword
...
Thus the wordfor "to plow" is not found in the Asiatic languages,
...
date, and into the countries to the northeven later; each time, the
nameforhemp camewiththeplant. Inmanyinstancestheabsence
of extralinguistic data does not allow us to ascertain whether the
presenceofthesamewordin severallanguagesisduetoborrowing
...
data. Forexample, common termsindicatingkinship areabundant
andhavebeentransmittedveryclearly. Theyallowustostatethat
...
sibleifit hadbeenborrowedfromanotherlanguage at a later date.
Herewemight consideranother morphological fact that has the
dual characteristic ofbeinglimited to a definite zone and oftouch-
...
field, for theuse of the suffix-no- informing secondary derivatives
...
prominence. Several Germanicwords are, I think, quite revealing
...
i.e. God), cf. Old Norse Drottinn, Anglo-SaxonDryhten, both with
final -ina-z.
=
...
Butagainitisworthnotingthatcomparisonsbetweenlanguages
...
terminated has a specialform, called "construct state," and precedes
the determinant. Take Hebrew dabar 'word' and ^elolilm} 'God':
dabar 'elohim means 'the word of God.' Should we saythatsucha
...
similar construction: cf. lecorRoland 'Roland'shorn,' lesquatrcfils
Aymon 'Aymon's four sons,' etc. Now the procedure arose in
Romance through sheer chance, morphologicalaswell asphonetic
-
a sharp reduction of cases forced the new construction on the lan-
gauge. It is entirely possible that a similar accident started Proto-
Semitic on the same route. Thus a syntactical fact that is appar-
entlyone ofitsindelibletraitsgives noaccurate clue to the Semitic
mind.
Anotherexample Proto-Indo-Europeanhadnocompoundswith
:
...
2The symbol ['] designates thealeforglottal stop that corresponds to soft
breathingin Greek. [S.]
...
theirancestors.
Wehaveseen
(p. 195) that theinnovationwasdue
...
tightyokeonthoughtandforceitintothespecialwaythatthe ma-
terial state of signs opens to it. A great number ofsimilar observa-
tions confirms this conclusion. The psychological character of the
linguisticgroupisunimportantbycomparisonwiththeelimination
...
to classifylanguages according to the procedures that they use for
expressingthought. Buteven after we become acquainted with the
structuresoflanguagesand classifythem, wecandrawnoaccurate
...
cludedinPartFivebecauseitservesasaconclusionforthewholework. [Ed.]
...
manenttraitswhichneithertimenorspace can change in anyway,
...
of the language fromwhich it derives. The sound system of Proto-
...
hasaroleintheinterplayofgrammaticaloppositions quantitative
;
rhythmisbasedsolelyontheoppositionoflongandshortsyllables;
...
Now itisclearthatnoneoftheforegoingtraitshasbeenretained
...
languageshaveeven changed thefeatures of Proto-Indo-European
to such an extent that they suggest an entu-ely different linguistic
type (e.g. English, Armenian, Irish, etc.).
Itwouldbemorefittingto speakofcertaintransformationsthat
...
offer striking differences. Slavic has putup the strongest resistance
while EngUshhasreducedinflectionalmosttozero. Tooffsetthis, a
rather stable word-order has developed, analytical processes of
expression havetended to replace synthetic processes, prepositions
express case values (see p. 180), auxiliarieshave taken the place of
...
someofthederivedlanguages. Thereverseisequallytrue. Itisnot
unusual even to find that the common traits of all the representa-
tives ofafamilydonotappearin theoriginal idiom. Thisis true of
...
mony isthen a comm
—
ontrait but not an original one
—;
consequently
...
traits ofthefamilyinherentin each language. Thefollowingtraits,
...
systemispoorlydeveloped (betterin Proto-Semitic, however, than
in the daughter languages) , with the result that strict rules govern
word-order. The mostnotable trait has to do with the structure of
the root (see p. 187). It regularly includes three consonants (e.g.
q-t-l'kill') whichareretainedineveryformwithinagivenlanguage
...
—
value ofwords while vowels with the help of certain prefixes and
—
...
anycharacteristicthatispreservedintimemayalsodisappearwith
...
of roots. For example, two sounds of the seriesi, u, r, I, m, n never
...
'word,' dbdr-im 'words,' dibre-hem 'theirwords,' etc. recall German
...
seizesupon the alternations, attaches grammaticalvalues to them,
and spreads them, using the analogical models which chance
phoneticdevelopmentsprovide. Theimmutabilityofthethree con-
sonants in Semitic is only a general rule, not a hard-and-fast one.
We could be sure of this a priori, but our viewis confirmed by the
...
consonants. Even if we agreethat Semitic roots are quasi-immuta-
...
beenbetterpreservedinthisgroupoflanguagesthanelsewhere. We
...
gauge as an organic thing with its own law of evolution, but we
continue, without suspecting it, to try to make language organic
in another senseby assuming that the "genius" of a race or ethnic

---

232 COURSE IN GENERAL LINGUISTICS
group tends constantly to leadlanguage along certain fixed routes.
...
INDEX
—
Ablaut, 158f.; 160 phonetic change, 151, 161; and
Accent, 86, 58 — analogy, 166
Agglutination, define—ition of —, 176; Articulation and auditory i — mpres-
three phases in , 177; co—n- sion, 8; two meanings o—f , 10,
trasted with analogy, 177f.; 113; diversity o—f oral , 42f.;
always precedes analogy, 179 no — te value of oral in classifying
Alphabet, see— Writing; borrowed sounds, 44; sistants or holds, — 52
28; Greek , 27, 39 and note; muscular image of
Altera—tion of the sign, 74f., linguis- 66
tic is always partial, 84, 87 Aspects of the verb, 117
Alteration,—157; de—finition, 158f
.
Associative facult—y, 13
laws of , 158; is — synchronic Atlas, linguistic , 202
and grammatical, 159; tightens Aufrecht, 3
the grammatical bond, 160f —
Analogy,—161-173; its importance, Beats, homogeneous of the
171; cou—nteracts phonetic spoken chain, 38
changes, 161; —as a proportion, Benfey, 3
161, 165, 167; and formative Berthelot, 25
elements, —162, 170; —mistakes con- Bopp, 2, 3, 24, 82, 18—4, 215
cerning , 162f.; is creation Boundary, syllabic , 57
and not cha—nge, 163f .; its mecha- Braune, 5
—nism, 163; is grammatical, 165 Broca, 10
originates in sp — eaking, 165,—168 Brugmann, 5
two theories of , 166f.; as —
—a force in evolution, 169, 171f.; Cartography, —linguistic ,— 202
indicates c—hanges in interpreta- Cavity, oral , 41; nasal —, 42.
tion, 169f .; —as a conservative Chain, phonic (or spoken) , 38f.;
force, 172f.; contrast—ed with 49f.; 51f.
folk etymology, 173f.; con- Changes in language,—originate in
trasted with agglu—tination, 177f speaking, 18, 98; are always
Analysis, —objective —, 183f.; sub- partial, 84f.; 87 —
jective , 183f.; and the de- Changes, m — orphological ,—93;
fining of subunits, 185f semantic , 93; s—yntactical —93
Anthropology and linguistics, 6, 222. Changes, phonetic , 143-161 ;
Aperture, basis— for classifying areunrelated—to thesystem oflan-
sounds, 44f.; and opening and gauge, 18f.; affect sounds, not
closing sounds, 52 words, 93; their regularity, 143;
Aphasia, 10f — absolute and conditioned, spo — n-
Apparatus, vocal
,
41f taneous and combinatory
Arbitrary natu—re of the sign, defini- 144f.; see Phonetics
tion, 67f.; and the i—mmutabil- Chess, compared with the system of
ity of language, 72f.; and al- language, 22f., 88,—110
teration, 74f .; absolute an — d rela- Children, role of in phonetic
tive arbitrariness, 131f.; and evolution, 149
235
...
INDEX
236
Climate and linguistic changes, Dou — blets, nonphonetic character of
147f., 198 , 115f. —
Community of speakers, 78 Dualities, linguistic , 8
Compar — ison of unrelated languages, —
192 ; of related languages, 4, Economy, political —, 79
199, 218 Entities, concrete — of language,
Co 2 t m 0 h p 9 e a f r s ., a ch t 2 o i 1 o v 5 l e of ph—ilol 3 o f g . y , , 24 m f i . s , t 1 a 6 k 3, es 18 o 4 f , Et m h 10 n a 2 i n c f . — ; un a i , b t 2 s y 2 t , r 6 a 2 c 2 t 3f.; , I 1 ta 3 l 7 ic f and Ger-
Compounds, products of — analogy, Ethnography and linguistics, 6, 20,
178 and note; Germanic , 141 —f., 222
2 1 2 7 7 8 f n . o ; te, Pr 2 o 2 t 7 o f -Indo-European E E t t r y u m s o c l a o n g s y, an f d olk Lat—in , s, 17 2 3 2 f 3 .; — with
Concept, 12, 66; called signified, 67, and without — t deformat—ion, 174; in-
103, 113f. complete , 174f.; compared
Consanguinity and linguistic com- with analogy, 174f
munity, 222 — Etymology and or — thography, 28, 31
Consonants, 48, 57f.; middle or uncertainty of , 225f.; defini-
tenues, 35 tion, 173 — —
Construction and structure, 178 Evolution, linguistic ,—8; begins
Co-ordinating —faculty, 13 in speaking, 18, 98; of gram-
Cords, vocal , 41 matical facts, 142; see Changes,
Curtius, 3 phonetic
Expiration, 42f —
Darmsteter, 32 Explosion, 51f.; duration—of , 60
De—limiting of linguistic units, 104f
.
Extension, geographical of lan-
of phonemes, 38 guages, 21; see Linguistics, geo-
Dentals, 45 graphical
Derivatives, products of analogy, —
178 Facts, grammatical and linguistic
Deschamps, 25 units, 122
Diachrony, 81; see also Linguistics, Faculty of speech, 9f.
diachronic — Families of languages, 6, 191f.;
Dialectal, borrowed— forms, 156 Indo-Europea — n family, 2, 204f.,
Dialects, natural do not—exist, — 209f.; Ban—tu , 192; Finno-Ugric
202; distinction b—etween and , 192; have no per — manent
languages, 203f.; and literary traits, 228f.; Ural-Atlaic , 230
language, 21, 195 Fashion, 75, 151 —
Diez, 5 — Formulas, articulatory for
Differences, role of in creating sounds, 44
values—, 114f., 117f.; there are Fortuitous character of a language-
only in language, 12—0 state, 85
Differentiation, linguistic o — n con- Fricatives, 46
tinuous territory, 199f .; on Furtive sounds, 54f., 220
separate territories, 208f
Diphthong, — implosive link, 61; "as- Gillieron, 31 note, 32 note, 202
cending" , 61 — Glottis, 41f.
Div
a
e
m
...
f
16
the vocalic system, 4
197; absolute , 192 — Grammar, definition—, 134; t—radi-
Dominus, etymology of , 226 tional or classical , 1, 82; is
...
237
—
norma — tive and static, 1, 8—2; gen- inte—rdependent, 18; how exists,
eral , 100; "historical" , 134, 19; is a form, not a substance,
142, 143 note 113, 122; languages and dialects,
Grammont, 32 note 204 —
Grimm, 3, 25 Languages, — Germanic , 5, 216;
Gutturals, 44, 46; palatals, 44, 46; Romance , 5, 213, 217; Semitic,
velars, 45, 46 and note 227, 230
Larch, 96
—
h, aspirate , 48; i—n French, 32f Larynx, 41f.
Harmony, vocalic of the Ural- Lateral consonants, 47f.
Altaic languages, 230 Lautverschiebung , see Mutation,
Hiatus, 59f. consonantal —
Hirt, 224 Law, Verner's —, 145
History of linguistics, If., 81—f.; re- La — ws, linguistic , 91f .; synchronic
lations between political and are general but—not imperative,
phonetic changes, 150 92f.; diachronic are impera-
Holds or sistants, 52 and note t—ive but not general, 93; phonetic
— ,
93f
.;—
wrong s—tatement of
Identity, s — ynchronic , 107f .; dia- phonetic , 145f.; of alterna-
chronic
,
181f tion, 158
Idiom, 191f. Least effort, cause of phonetic
Immutability of the sign, 7—1f changes, 148
Implosion, 51f.; duration of , 60 —f. Leskien, 5
Indirect spellings, 29; fluctuating Lexicology, a part of grammar, 135
29f
.;
see Writing Limiting of arbitrariness, basis for
In
—
do-European, characteristics of the study of language, 133f
, 229 — Linguisti—cs is a part of semio—logy,
Inflection, 185; zero , 185 — 15f.; of language and of
Institution, language is a social speaking, see— Language; external
10, 16 and inter—nal , 20f.; synchronic
Intercourse or un — ifying force, 205f.; or static , 81, 99f.; "historical,"
two forms of , 206 diachronic, or evolution — ary, 81,
Interjections, 69 99, 140f.; geographical , 191f.
Isogloss lines, 203 Liquids, 44, 47f.
Lithuanian, 24, 216
Jespersen, 40 note, 42 note Loan-words, 21, 36, 155f., 225
Jones, 2
Mechanism of language, 127f., 130,
Koine or literary Greek, 196 165
Kuhn, 3, 204, 224 Meillet, 92 note
Meter, 36 — —
I, denta—l, guttural, nasal, and pa- Method, comparative , 3f.; of
latal 47 external an — d of internal Unguis-
Labials, 45 tics, 22f.; of synchronic and
Labio-dentals, 46 diachronic linguistics, 90f—.; pros-
Language, no — rm of the facts of pective and retrospective —, 212f
speech, 9; is social, h — omogen- Migrations, 204f.; theory of , 209
ous, and concrete, 14f.; is dis- Millardet, 202 note
tinct— from speaking, 14f., 17f., 77, Morphology, inseparable from syn-
165; is not—a name-giving sys- tax, 135
tem, 16, 65; and speaking are Morris, 16 note

---

… … .,
238 INDEX
Motivation, 131f. tagmatic and associative relations,
Mo — vements, facilitating articulatory 130f. —
,
55 Phonetics, 32f.; and grammar,
M M i u i t l a l b er i , li 3 ty of the sign, 7 — 4f. s 1 i 7 gn f i ., fic 1 a 5 n 2 t, ; 1 p 8 h , on 1 e 4 t 0 i f c .; m — ea i n s s a n p o a n r - t
Mutation, consonantal , 25, 144, of diachronic linguistics, 140
207 Phonographic recordings, 23
Phonological species, 40, 53
Names denoting kinship in Proto- Phonology, 32-64; —wrongly called
Indo-European, 225f phonetics, 32f.; is a part —of
Nasalized sounds, 43 speaking, 33; combinatory
N Na a v s i a l l l s e , , 4 1 5 6 ; n v o o t i e celess — , 45 Ph 5 y 0 si f. ology and linguistics, 7
Neogrammarians, 5, 184 Physiology of sounds, see Phonol-
Non-sonants, 57f. ogy
Nyrop, 36 Pictet, 216, 224
Plural and dual, 116
Polite formulas, 68
Occlusives, 45f
Pott, 3
Ol—d, three meanings of the word
Prefix, 187f.
Old S a l p a p v l i i c, ed 22 t , o 2 l 1 a 7 nguage, 215f. P Pr r e e p h o i s s i t t o i r o y ns, and un l k in n g o ui w s n tics i , n 6, Pr 2 o 2 t 3 o f - .
Onomatopoeia, 69 Indo-European, 180
Opposition and difference, 121 Preservation of linguistic forms, 173
Orthography, 25f .; see Writing and Preverbs, unknown in Proto-Indo-
Spelling European, 180
O O s p t e h n o i ff n , g 5 sounds, 52 Pr b o e c t ed w u e r e e n — an , d 17 p 6 rocess, distincti — on
Pronunciation and writing, 29f.; —
Palatals, 46f. determined by etymology, 31;
Palate, 41 — corrupted by wri—ting, 31f.; rela-
Paleontology, linguistic , 224 tive freedom of , 119
Panchronic viewpoint, 9
—
5f Proto-Indo-European, 228f
Paradigms, inflectio—nal , 127 Provincialism and —intercourse, 205f
Participle, present , 96 Psychology, social and linguistics,
Parts of speech, 109, 138 7, 16
Paul, 5 — —
Peak, vocalic , 57 r, trilled and burr, 47
Permutation, synonym of alterna- Race and language, 222f.
tion, 160 Radical or theme, 185f
Perspective—, synchronic and dia- Reading and writing,— 34
chronic ,81, 87,—90; prospective Reality, s — ynchronic , 109; dia-
and retrospective
—,
212f. chronic
,
181
—
Philology, m — ethod of , 1, 7; com- Reconstruction, linguistic , 218f.
parative
,
2 Relation—s, sjmtagmatic and associa-
P Ph h o o n n a e t m i e o s n , , u f n i r xe e d lat n e u d mb to er lan o g f ua — ge , , 1 1 5 8 , t e i n v c e e, 12 , 8 1 f 2 . 2 ; f t . h ; ei t r hei r r ole in i t n er d— d e e t p e e r n m d - -
34, 40, 119, 220; their delimita- ining phonemes, 130f.; are
tion, 3—8, 42f.; their description, the basis for the divisions of
39f.;— are differential, 54, 119, grammar, 136f
221; and sounds, 66; their syn- Rhotocization, 144, 146
...
239
—
Ritschl, 1 closi — ng and opening , 52; fur-
Root, def—inition, 186; characteri—stics —tive , 54f., 220 ; shapelessness of
of the in Ge — rman, 186f .; in , 111. —
French, 187; in the Semitic Speaking, an individual act, 14;
languages, 187, 230 is distinct from language, see La — n-
Roudet, 40 note gauge—; mode of existence of
— 19; is the seat of linguistic
Sanskrit, discovery of , 2 —f.; exag- change, 19, 98, 143 note, 168
gerated — importance of , 215f.; Speaking-circuit, 11f. — —
age of 216 Species, phonological ,40; are
,
Schleicher, 3, 4, 231 abstract, 53f
Schmidt, 203, 209, 224 Sp—eech, language and speaki—ng, 77;
Semantics, 16 note is heterogenous, —9; is a
Semiology, definition, 16; based natural faculty, 9f.; is articu-
mainly on systems of arbitrary lated, 10 —
signs, 67f Speech, parts of —, 109, 138
Semi-vowels, 48— — Sp — eUing, indirect , 29; fluctuating
Sentence, 124; as a unit, 106; , 29f.; see Writing
equivalents, 128 — Spirants, 46f —
Separation, geographical and lin- Stability, political and phonetic
guistic differentiation, 208f changes, 150f. —
Shift in the relationship between Substratum, linguistic and phon-
the signifier and the signified, 75 etic changes, 151
Sievers, 5, 40 not — e, 58, 61, 62 Subunits of words, 106, 127f., 129,
Sign, linguistic , its composition, 185f. —
66f.; its immutabi — lity, 71f.; its Suffix, 178; zero , 186
mutability, 74f.; considered in Syllable, 50, 57f.
its totality, 120f.; unmotivated Syllabic boundary, 57f
and relative—ely motivated signs, Symbol, contrasted with sign, 68f
131f.; zero , 87, 118, 185, 187 Synchrony, see Linguistics, syn-
Signification, 114f. chronic
Signified, 67, 102f.; see Signifier Syntagm, definition, 122f.; see Re-
Sig—nifier, define—ition, 67
;
linearity of lations, syntagmatic
, 70, 123 ; exists only through Syntax, 135f.
the signified and vice versa. 102f System of language, 8, 22f., 72f.,
Silbenbildend and silbisch, 59, 61 79, 113, 133; see Mec — hanism.
Sociology and linguistics, 6 System, phonological , 34f., 221.
Solidariti—es, syntagmatic and associ-
ative
,
127f., 133
Sonant, 57 ; Proto-Indo-European Tense, 116f. —
sonants, 51, 63 Terminology, linguistic is—in-
So—nority of phonemes, 43; role of exact, 5 note; phonological is
Sound i , n c s o y m l p l l ab e i x c i a t t y ion o , f 5 — 8 ,8; — and Th i e mp m e e rf o e r ct r , adi 4 c 4 al, 185f. —
audit — ory impre—ssion, 38f.; lary—n- Thought, shapele—ssness of , 111
geal , 42f.; and noise, 48; Time, effect of on language, 74,
is not language, 110 — 78, 197f.
Sound-image, 12, 15,—66 note; is Trombetti, 192 —
psychological, 66; is called sig- Type, linguistic and — mind of the
nifier, 67 — social group, 227f.; and fami-
Sounds, classification of , 43f.; lies of languages, 228f.
...
INDEX
240
Umlaut, 24, 83f.,—157 Wenker, 202
Uni—ts, linguistic , 103f .; complex Wellentheorie, 209
, 1—05f., 124 ; problems in defi—n- Whitney, 5, 10, 76
ing , llOf.; importance of — Wolf, 1
110f.; d—ifferential character of Words and units contrasted, 105f
.,
121 £.; and gramma — tical facts, 113f.
122, 179; diachronic , 181 Word-unit and phonetic changes, 94
Unsilbisch, 61 Writing and lan — gauge, —15; necessity
Uvula, 41f. for studying ,23;— is distinct
from language, 23; is not nec-
Val c u e e p , tua l l ing s u i i d s e t , ic 11 — 4f , .; 11—0f. i ; s i d t i s st c i o n n c - t e— — ssa a r n y d f t or he li l n i g t u e i r s a t r i y c l s a t n ab g i u l a i g t e y , , 2 2 4 5 ; ;
from signification, 114; its ma- changes less frequently — than
Vel
t
a
e
...
-
-
5 a 7 nd f.; vo o i p c e el n es a s n — d , cl 4 o 8 se f d, whispered, n o ( e t S s t e ) i m , c it 2 e 6 s , ) , , 2 3 6 9 3 , ; 9 5 s 0 y ; lla c b o ic nsonan ( t C a y l pr—i-
—
Waves, innovating , 203, 206 Zend, 22
Weigand, 202 note Zones, dialectal, 199f.

---

---

UniversityofCalifornia Library
LosAngeles
Thisbookis DUEonthelastdatestampedbelow.
RECEIVED
MAR
1 7 2005
UCLA LAW
