---
title: "A.2 What does anarchism stand for?"
type: "[[Reading]]"
domain: "[[The Commons]]"
Lifestage: "🌱 Seed"
status: recovered
...
section A.2.2 --  [Why do anarchists emphasise liberty?](secA2.html#seca22)).
...
interact. (See also section A.2.5 -- [Why are anarchists in favour of equality?](secA2.html#seca25))
...
which weakens society as a whole. (See also section A.2.6 -- [Why is solidarity important to anarchists?](secA2.html#seca26))
...
recommendations (see [section B.1](secB1.html#secB1) for more
...
(see [section J.2](secJ2.html)) for, as Emma Goldman argued,
...
is blunted (see also [section B.1](secB1.html)).
...
(see [section A.2.9](secA2.html#seca29) for more on anarchist organisation). For authority is the opposite of liberty, and hence any form of organisation
...
(See
[section B](secBcon.html) for further discussion
...
B.2.3](secB2.html#secb23)), it is able to suppress
...
[section A.2.14](secA2.html#seca214), anarchists stress
...
democracy and confederation will be discussed further in sections  [A.2.9](secA2.html#seca29)
and  [A.2.11](secA2.html#seca211).
...
> *"Disobedience is the true foundation of liberty. The obedient must be slaves."*## A.2.5 Why are anarchists in favour of equality?

As mentioned in[above](secA2.html), anarchists are dedicated to
...
place little or no value on equality?"](secF3.html)) discusses anarchist ideas on equality
...
Anarchists Do?"](secJcon.html)) and will
...
[section J.2](secJ2.html) for details).
...
of doing both -- see sections [J.2](secJ2.html)
and [J.4](secJ4.html)). Capitalism and statism
...
consciousness"*** -- see [section B.7.3](secB7.html#secb73)). And self-liberation through
...
For more on this see section A.2.14 ([Why is voluntarism not enough?](secA2.html#seca214)).
...
is a contradiction in terms. (For more on this, see [Section F](secFcon.html))
...
large groups (see section [A.2.12](secA2.html#seca212)).
...
look like see [section I](secIcon.html). Anarchy,
...
as we discuss in [section I.2.3](secI2.html#seci23), see the framework of a free society
...
see section B.1 -- ["Why are anarchists against authority and hierarchy?"](secB1.html)).
...
(see [section B.3](secB3.html) for more details). Ironically, the *"abolition of
...
nature (see[section A.2.14](secA2.html#seca214)
for more discussion).
...
section B.1 - ["Why are anarchists against authority and hierarchy?"](secB1.html) - for more on this). Thus Proudhon:
...
( [What sort of society do anarchists want?](secA2.html#seca29))
and discussed in greater detail in section I ([What
would an anarchist society look like?](secIcon.html)).
...
(see the [next section](secA2.html#seca212) on consensus and
...
sections [A.2.14](secA2.html#seca214) and
[B.4](secB4.html) for further details).
...
[section B.4,](secB4.html) this is
...
many obey (see also [section A.2.8](secA2.html#seca28)). Thus any voluntarism which generates
...
[section A.3.5](secA3.html#seca35) for more on feminism and anarchism).
...
( [Section A.2.11](secA2.html#seca211)  discusses why direct democracy is the necessary social
counterpart to voluntarism (i.e. free agreement).  [Section B.4](secB4.html) discusses
...
[section I.5.8](secI5.html#seci58) for a discussion
of how could be done for anti-social activities as well as disputes).

Like the "anarchism-is-against-human-nature" argument (see [section A.2.15](secA2.html#seca215)), opponents of anarchism usually assume "perfect" people --
...
form immediately (see [section H.2.5](secH2.html#sech25)
...
A.5.6](secA5.html#seca56)) and Italy (see
[section A.5.5](secA5.html#seca55)) show
...
attempts to recreate authority (see [section H.2.1](secH2.html#sech21) for a refutation
...
discuss in [section I.2.3](secI2.html#seci23),
...
influence the struggle and spread our ideas (see [section J.3](secJ3.html) for
...
and the conformity produced by authority. (See also [section B.1](secB1.html) for more on the effects of hierarchy). As Bob Black points
outs:
...
> Alternative Futures**, p. 780]## A.2.18 Do anarchists support terrorism?
...
[section A.2.16](secA2.html#seca216) for more on this). As we have stressed earlier, freedom
...
unions after 1890 (see [section A.5.3](secA2.html#seca53)).
...
in [section A.3.7](secA3.html#seca37), there are anarchists who do believe in god or some
