---
title: "F.10 Would laissez-faire capitalism be stable?"
type: "[[Reading]]"
domain: "[[The Commons]]"
Lifestage: "🌱 Seed"
status: recovered
...
approximation see the section [F.10.3](secF10.html#secf103)). This section of the FAQ is an
...
[F.10.1](secF10.html#secf101)) followed by the effects of the labour market on economic stability
(in section [F.10.2](secF10.html#secf102)). Then we will indicate, using the example of 19th
...
cycle is inherent in the system (see also sections [C.7](secC7.html), [C.8](secC8.html) and [C.9](secC9.html)).
...
supply of savings. But, as we argued in section [C.8](secC8.html), it is not at all
...
we discuss in the [next section](secF10.html#secf102) and yet another is the endogenous nature
...
we noted in section [C.5.1](secC5.html#secc51), the larger the firm, the lower the interest
...
actually speed up the coming of a slump. As we argue in the [next section](secF10.html#secf101),
...
section [F.3.1](secF3.html#secf31)) makes a mockery of right-libertarian claims that their
...
most firms (as we indicated in section [C.5.1](secC5.html#secc51)) fund their investments
...
section [F.10.3](secF10.html#secf103), the USA suffered massive economic instability
...
But under full employment this changes. As we argued in section [B.4.4](secB4.html#secb44)
and section [C.7](secC7.html), in such a situation it is the bosses who have to
...
Indeed, as we argued in the [last section](secF10.html#secf101), the extended periods of
...
a "pure" capitalism (for reasons we discussed in the [last section](secF10.html#secf101)) and
...
be subject to periods of unemployment (as we argued in section [C.9](secC9.html))
...
Moreover, as we argued in-depth in section [C.9](secC9.html), a cut in money wages is
...
effects of lowering wages on demand discussed in section [C.9](secC9.html)).
...
(and as we argue in section [C.9](secC9.html), cutting these wages will result in
...
is clear (see section [J.5.12](secJ5.html#secj512)) that bosses hate to have their authority
...
associated with over-investment (see section [C.7.2](secC7.html#secc72)), credit and interest
rate problems (see section [F.10.1](secF10.html#secf101)) and realisation/aggregate demand
...
we argued in section [F.8](secF8.html), it is the "quasi" aspects of the system that
