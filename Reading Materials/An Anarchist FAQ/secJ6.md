---
title: "J.6 What methods of child rearing do anarchists advocate?"
type: "[[Reading]]"
domain: "[[The Commons]]"
Lifestage: "🌱 Seed"
status: recovered
...
**Red Emma Speaks**, p. 108] In this section of the FAQ we will discuss
...
introduction to his ideas can be found in Maurice Brinton's **The Irrational
in Politics**). In **Children of the Future**, Reich made numerous suggestions,
...
Section [J.6.1](secJ6.html#secj61) will examine the theoretical principles involved in raising
free children, while subsequent sections will illustrate their practical
application with concrete examples. Finally, in section [J.6.8](secJ6.html#secj68), we will
...
freedom."* [Michael Bakunin, **The Political Philosophy of Bakunin**, p. 327]
...
to the whims and fancies of those about it?"* [Emma Goldman,
**Op. Cit.**,
...
[Martha A. Ackelsberg, **Free Women of Spain**, p. 132]
...
> outgrowing the old."* [**Children of the Future**, pp. 38-39]
...
A.S. Neill writes in **Summerhill**, *"There is a slow trend to freedom, sexual
...
forth (see [next section](secJ6.html#secj62)). However, once the child has been armoured
...
this can be done will be discussed in the [next section](secJ6.html#secj62).
...
these, see Alexander Lowen, **Physical Dynamics of Character Structure**,
...
have."* [**Depression and the Body**, p. 133]
...
[Neill, **Summerhill**, p. 336] Indeed, in **The Physical Dynamics of
Character Structure**, Lowen has traced specific neuroses, particularly
...
> adults were speaking." [**Summerhill**, p. 97]
...
kinds, which should be encouraged and not hindered."* [**Children of the
Future**, p. 66]
...
have, but they will be short-lived and not tend toward neurosis."* [**Ibid.**, p. 166]
...
his interest; and in doing so, kill it."* [**Summerhill**, p. 174]
...
effect on health."* [**Children of the Future**, p. 217] Citing ethnological studies, he notes the following:
...
bad citizen."* [**Summerhill**, p. 107, 167]
...
[I.4.10](secI4.html#seci410)). Creative people work for the pleasure of creating; monetary
...
section [B.1.5](secB1.html#secb15)). This sea-change in social attitudes toward childhood
