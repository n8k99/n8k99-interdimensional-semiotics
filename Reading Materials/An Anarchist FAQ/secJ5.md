---
title: "J.5 What alternative social organisations do anarchists create?"
type: "[[Reading]]"
domain: "[[The Commons]]"
Lifestage: "🌱 Seed"
status: recovered
...
an anarchist life."* [Errico Malatesta, **The Anarchist Revolution**,
p. 28]

As will quickly become obvious in this discussion (as if it had not
been so before!) anarchists are firm supporters of ***"self-help,"***
...
slogan of the **First International** that *"the emancipation of
the working class must be the task of the working class itself"*? So,
...
[**Kropotkin's Revolutionary Pamphlets**, p. 158, p. 147, p. 150,
...
sections [J.1.4](secJ1.html#secj14) and [J.1.5](secJ1.html#secj15) for more details on anarchist opinions on such
...
as typical, to such schemes see Graham Purchase's book **Evolution & Revolution**, pp. 122-125). Dropping out will not stop capitalism and
...
in a capitalist economy -- see section [J.5.11](secJ5.html#secj511) -- and was actively done
...
> independence will be respected."* [**Libertarian Communism**,
pp. 6-7]

The combination of community unionism, along with industrial unionism
(see [next section](secJ5.html#secj52)), will be the key of creating an anarchist society,
...
helps combat these tendencies -- see section [J.3.9](secJ3.html#secj39)).
...
will be discussed in the [next section](secJ5.html#secj53).
...
networks -- see [next section](secJ5.html#secj53)).
...
As noted in the [last section](secJ5.html#secj52), anarchists desire to create organisations
...
["What are Industrial Networks?"](secJ5.html#secj54)).
...
Unionism we highlighted in the [last section](secJ5.html#secj52) -- namely direct workers
...
based upon the ideas of industrial unionism (see section [J.5.2](secJ5.html#secj52)) could grow
and expand.
...
in section [J.5.2](secJ5.html#secj52)). The role of the anarchist group or anarcho-syndicalist
...
Mutualism, as noted in the [last section](secJ5.html#secj55), is a form of credit co-operation,
...
in order to be both useful and effective (see section [B.3.2](secB3.html#secb32) for more
...
example, community unions (see section [J.5.1](secJ5.html#secj51)) could create their own
...
(see section [J.5.11](secJ5.html#secj511)) as well as providing a firm framework of support
...
(as we will discuss in section [J.5.12](secJ5.html#secj512)).
...
work -- and, as we will discuss in section [J.5.12](secJ5.html#secj512), the capitalist market
...
labour in maximising profits and returns on capital (see [next section](secJ5.html#secj512) for more on this).
...
(see [last section](secJ5.html#secj511)), many supporters of "free market" capitalism will claim
...
As we noted in [section D.10](secD10.html),
...
capitalism -- see [last section](secJ5.html#secj511)).
...
**Op. Cit.**, pp. 178-248). This is why profit maximisation
...
> mythology as a description of reality."
...
just like a co-op business."* [quoted by Noble,
**Op. Cit.**, p. 295]
...
in "green" technology, see [section E.5](secE5.html)).
...
would all be rolled into one"* [cited by Steward Edward in **The Paris
Commune**, p. 274]
...
of national education systems) when he wrote in **An Enquiry Concerning
...
capacity."* [cited by Colin Ward, **Anarchy in Action**,
p. 81]
...
[quoted by Juliet B. Schor in **The Overworked American**, p. 61]
...
> hands of the ruling class."* [cited by Clifford Harper, **Anarchy: A Graphic
> Guide**, p. 100]
...
utterly foreign to itself."* [**Red Emma Speaks**, p. 118, p. 116]
...
**Anarchism and Other Essays** and A.S Neil's **Summerhill**. For a good
...
Anarchism** and Michael Bakunin's *"All-Round Education"* in **The Basic
Bakunin**. For an excellent summary of the advantages and benefits
of co-operative learning, see Alfie Kohn's **No Contest**.
...
and with the economic forces that underpin statism as such."* [**Democracy
and Nature** no. 9, p. 158] This would be part of a social wide
...
community. . ."* [**From Urbanisation to Cities**, p. 266]
...
As noted in section [J.5.1](secJ5.html#secj51), many anarchists are doing just that and
...
old ones altogether)."* [**From Urbanisation to Cities**, p. 267]
...
[J.2.2](secJ2.html#secj22) and [J.2.4](secJ2.html#secj24), such as the fact that voting ratifies the current system?
...
[J.2.6](secJ2.html#secj26)). History is littered with radical, politically aware movements
...
create them (see section J.5.1 - ["What is Community Unionism?"](secJ5.html#secj51) for
...
expressed in the law an accomplished **fact**."* [**Kropotkin's Revolutionary
Pamphlets**, p. 171] Most anarchists, therefore, think it is far more
...
attacks on it? (see [next section](secJ5.html#secj516) for a short
...
[*"Rollback III"*, **Z Magazine**, April, 1995] The same can be said for
...
communal community welfare projects (see [next section](secJ5.html#secj516)). Moreover, in the
...
> self-reliance."* [Bob Holton, **British Syndicalism: 1900-1914**,
> p. 137]
...
Pateman, *"The Patriarchal Welfare State"*, in **The Disorder of Women**,
...
> is still stuck in the groves of nineteenth-century paternalism." [**Anarchy
> in Action**, p.73]
...
> just the contrary purpose."* [**Radical Political Economy** Vol. 2, p. 363]
...
UK -- called, ironically enough, **welfare to work** -- involves losing
...
together). And it is **this**, the potential benefits welfare can have
for working people, that is the **real** cause for the current capitalist
attacks upon it.
...
themselves."* [**Expanding the Floor of the Cage**]
...
(and as we have explained in detail in sections [B](secBcon.html),
[C](secCcon.html) and [D](secDcon.html), capitalism is
...
A point we will discuss more in section [J.5.16](secJ5.html#secj516) when we highlight the
...
vulnerable utopia that was."* [Colin Ward, **Social Policy: an
anarchist response**, p. 3]
...
than Kropotkin's **Mutual Aid**. Here we will (using other sources than
**Mutual Aid**) indicate a few examples of collective welfare in action.
...
movement and the Co-operative movement."* [Colin Ward, **Social Policy:
an anarchist response**, p. 2]
...
his neighbour.'"* [**The Making of the English Working Class**,
...
and other users of the current welfare state (see [last section](secJ5.html#secj515)).
...
> bureaucracies."* [**Anarcho-Syndicalism**, p. 54]
...
[last section](secJ5.html#secj515), it is worthwhile to
...
is more competition for patients."* [Alfie Kohn, **No Contest**, p. 240]
...
[**Wall Street**, p. 305] Although market competition was supposed to lower
...
taxable salary. As argued in section [C.4](secC4.html), such oligopolistic tendencies
...
Social Security in South America,"* **The American Prospect** no. 33,
...
The struggle **against** capitalism and statism requires that
we build **for**
the future (*"the urge to destroy is a creative urge"* - Bakunin) and,
moreover, we should remember that *"he who has no confidence in the creative capacity of the masses
...
praying. Because he is no revolutionist. He is a son of a bitch."*
[Sam Dolgoff, quoted by Ulrike Heider, **Anarchism: left, right,
and green**, p. 12]
