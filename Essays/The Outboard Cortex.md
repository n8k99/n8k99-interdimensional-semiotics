...
Consider the existing vault. Markdown files with frontmatter, organized into nine domains, linked by wikilinks, indexed by tags, queried by Dataview, traversed by daily and weekly notes. Read this as a pattern hierarchy and the architecture is already there:
